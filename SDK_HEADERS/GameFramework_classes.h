...
{
public:
	struct FInterpCurveFloat                           AnimatedScale;                                    		// 0x0218 (0x0010) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	struct FInterpCurveLinearColor                     AnimatedColor;                                    		// 0x0228 (0x0010) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	struct FInterpCurveVector2D                        AnimatedPosition;                                 		// 0x0238 (0x0010) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	struct FVector                                     LocationOffset;                                   		// 0x0248 (0x000C) [0x0000000000000001]              ( CPF_Edit )
	int                                                LoopCount;                                        		// 0x0254 (0x0004) [0x0000000000000001]              ( CPF_Edit )
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 1332 );
...
// 0x000C (0x03A8 - 0x039C)
class AFrameworkGame : public AGameInfo
{
public:
	TArray< struct FRequiredMobileInputConfig >        RequiredMobileInputConfigs;                       		// 0x039C (0x000C) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 1333 );
...
{
public:
	class UGameAICommand*                              CommandList;                                      		// 0x0390 (0x0004) [0x0000000004002003]              ( CPF_Edit | CPF_Const | CPF_Transient | CPF_EditInline )
	unsigned long                                      bHasRunawayCommandList : 1;                       		// 0x0394 (0x0004) [0x0000000000002000] [0x00000001] ( CPF_Transient )
	unsigned long                                      bAILogging : 1;                                   		// 0x0394 (0x0004) [0x0000000000004001] [0x00000002] ( CPF_Edit | CPF_Config )
	unsigned long                                      bAILogToWindow : 1;                               		// 0x0394 (0x0004) [0x0000000000004001] [0x00000004] ( CPF_Edit | CPF_Config )
	unsigned long                                      bFlushAILogEachLine : 1;                          		// 0x0394 (0x0004) [0x0000000000004001] [0x00000008] ( CPF_Edit | CPF_Config )
	unsigned long                                      bMapBasedLogName : 1;                             		// 0x0394 (0x0004) [0x0000000000004001] [0x00000010] ( CPF_Edit | CPF_Config )
	unsigned long                                      bAIDrawDebug : 1;                                 		// 0x0394 (0x0004) [0x0000000000004001] [0x00000020] ( CPF_Edit | CPF_Config )
	unsigned long                                      bAIBroken : 1;                                    		// 0x0394 (0x0004) [0x0000000000002000] [0x00000040] ( CPF_Transient )
	class AFileLog*                                    AILogFile;                                        		// 0x0398 (0x0004) [0x0000000000002000]              ( CPF_Transient )
	float                                              DebugTextMaxLen;                                  		// 0x039C (0x0004) [0x0000000000000001]              ( CPF_Edit )
	TArray< struct FAICmdHistoryItem >                 CommandHistory;                                   		// 0x03A0 (0x000C) [0x0000000000402003]              ( CPF_Edit | CPF_Const | CPF_Transient | CPF_NeedCtorLink )
	int                                                CommandHistoryNum;                                		// 0x03AC (0x0004) [0x0000000000004001]              ( CPF_Edit | CPF_Config )
	TArray< struct FName >                             AILogFilter;                                      		// 0x03B0 (0x000C) [0x0000000000404001]              ( CPF_Edit | CPF_Config | CPF_NeedCtorLink )
	struct FString                                     DemoActionString;                                 		// 0x03BC (0x000C) [0x0000000000400020]              ( CPF_Net | CPF_NeedCtorLink )
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 1334 );
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 1335 );
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 1336 );
...
{
public:
	unsigned long                                      bWarnCrowdMembers : 1;                            		// 0x05B4 (0x0004) [0x0000000000000000] [0x00000001] 
	unsigned long                                      bDebugCrowdAwareness : 1;                         		// 0x05B4 (0x0004) [0x0000000000000001] [0x00000002] ( CPF_Edit )
	unsigned long                                      bIsWarmupPaused : 1;                              		// 0x05B4 (0x0004) [0x0000000000002000] [0x00000004] ( CPF_Transient )
	unsigned long                                      bEnableMouseCursor : 1;                           		// 0x05B4 (0x0004) [0x0000000000002000] [0x00000008] ( CPF_Transient )
	float                                              AgentAwareRadius;                                 		// 0x05B8 (0x0004) [0x0000000000000000]              
	struct FName                                       CurrentSoundMode;                                 		// 0x05BC (0x0008) [0x0000000000002000]              ( CPF_Transient )
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 1337 );
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 1338 );
...
// 0x0208 (0x03FC - 0x01F4)
class AGameCrowdAgent : public ACrowdAgentBase
{
public:
	struct FPointer                                    VfTable_IInterface_RVO;                           		// 0x01F4 (0x0004) [0x0000000000801002]              ( CPF_Const | CPF_Native | CPF_NoExport )
	...
	struct FVector                                     PendingVelocity;                                  		// 0x0208 (0x000C) [0x0000000000000000]              
	class AGameCrowdDestination*                       CurrentDestination;                               		// 0x0214 (0x0004) [0x0000000000000000]              
	class AGameCrowdDestination*                       BehaviorDestination;                              		// 0x0218 (0x0004) [0x0000000000000000]              
	class AGameCrowdDestination*                       PreviousDestination;                              		// 0x021C (0x0004) [0x0000000000000000]              
	float                                              InterpZTranslation;                               		// 0x0220 (0x0004) [0x0000000000000000]              
	int                                                Health;                                           		// 0x0224 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              DeadBodyDuration;                                 		// 0x0228 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	class UDynamicLightEnvironmentComponent*           LightEnvironment;                                 		// 0x022C (0x0004) [0x00000000040A000A]              ( CPF_Const | CPF_ExportObject | CPF_EditConst | CPF_Component | CPF_EditInline )
	int                                                ConformTraceFrameCount;                           		// 0x0230 (0x0004) [0x0000000000002000]              ( CPF_Transient )
	TArray< struct FNearbyDynamicItem >                NearbyDynamics;                                   		// 0x0234 (0x000C) [0x0000000000402000]              ( CPF_Transient | CPF_NeedCtorLink )
	...
	unsigned long                                      bPotentialEncounter : 1;                          		// 0x0240 (0x0004) [0x0000000000000000] [0x00000100] 
	unsigned long                                      bIsPanicked : 1;                                  		// 0x0240 (0x0004) [0x0000000000000000] [0x00000200] 
	unsigned long                                      bWantsGroupIdle : 1;                              		// 0x0240 (0x0004) [0x0000000000000000] [0x00000400] 
	unsigned long                                      bPreferVisibleDestination : 1;                    		// 0x0240 (0x0004) [0x0000000000000001] [0x00000800] ( CPF_Edit )
	unsigned long                                      bPreferVisibleDestinationOnSpawn : 1;             		// 0x0240 (0x0004) [0x0000000000000001] [0x00001000] ( CPF_Edit )
	unsigned long                                      bHasNotifiedSpawner : 1;                          		// 0x0240 (0x0004) [0x0000000000000000] [0x00002000] 
	unsigned long                                      bIsInSpawnPool : 1;                               		// 0x0240 (0x0004) [0x0000000000000000] [0x00004000] 
	unsigned long                                      bPaused : 1;                                      		// 0x0240 (0x0004) [0x0000000000000001] [0x00008000] ( CPF_Edit )
	...
	float                                              AvoidOtherRadius;                                 		// 0x025C (0x0004) [0x0000000000000001]              ( CPF_Edit )
	TArray< struct FAvoidOtherSampleItem >             AvoidOtherSampleList;                             		// 0x0260 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	float                                              PENALTY_COEFF_ANGLETOGOAL;                        		// 0x026C (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              PENALTY_COEFF_ANGLETOVEL;                         		// 0x0270 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              PENALTY_COEFF_MAG;                                		// 0x0274 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              MIN_PENALTY_THRESHOLD;                            		// 0x0278 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              LastProgressTime;                                 		// 0x027C (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              LastFallbackActiveTime;                           		// 0x0280 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              MaxPathLaneValue;                                 		// 0x0284 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              CurrentPathLaneValue;                             		// 0x0288 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	int                                                ExtraPathCost;                                    		// 0x028C (0x0004) [0x0000000000000001]              ( CPF_Edit )
	...
	class UClass*                                      NavigationHandleClass;                            		// 0x02E4 (0x0004) [0x0000000000000000]              
	class UNavigationHandle*                           NavigationHandle;                                 		// 0x02E8 (0x0004) [0x0000000000000000]              
	int                                                ObstacleCheckCount;                               		// 0x02EC (0x0004) [0x0000000000000000]              
	float                                              WalkableFloorZ;                                   		// 0x02F0 (0x0004) [0x0000000000000000]              
	float                                              LastPathingAttempt;                               		// 0x02F4 (0x0004) [0x0000000000000000]              
	float                                              LastUpdateTime;                                   		// 0x02F8 (0x0004) [0x0000000000000000]              
	float                                              NotVisibleLifeSpan;                               		// 0x02FC (0x0004) [0x0000000000000001]              ( CPF_Edit )
	class AGameCrowdAgent*                             MyArchetype;                                      		// 0x0300 (0x0004) [0x0000000000000000]              
	float                                              MaxWalkingSpeed;                                  		// 0x0304 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              MaxRunningSpeed;                                  		// 0x0308 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              MaxSpeed;                                         		// 0x030C (0x0004) [0x0000000000000000]              
	TArray< struct FRecentInteraction >                RecentInteractions;                               		// 0x0310 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	float                                              BeaconMaxDist;                                    		// 0x031C (0x0004) [0x0000000000000000]              
	struct FVector                                     BeaconOffset;                                     		// 0x0320 (0x000C) [0x0000000000000000]              
	class UTexture2D*                                  BeaconTexture;                                    		// 0x032C (0x0004) [0x0000000000000002]              ( CPF_Const )
	struct FLinearColor                                BeaconColor;                                      		// 0x0330 (0x0010) [0x0000000000000002]              ( CPF_Const )
	class USoundCue*                                   AmbientSoundCue;                                  		// 0x0340 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	class UAudioComponent*                             AmbientSoundComponent;                            		// 0x0344 (0x0004) [0x0000000004080008]              ( CPF_ExportObject | CPF_Component | CPF_EditInline )
	class UGameCrowdAgentBehavior*                     CurrentBehavior;                                  		// 0x0348 (0x0004) [0x0000000000000000]              
	float                                              CurrentBehaviorActivationTime;                    		// 0x034C (0x0004) [0x0000000000000000]              
	TArray< struct FBehaviorEntry >                    EncounterAgentBehaviors;                          		// 0x0350 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	TArray< struct FBehaviorEntry >                    SeePlayerBehaviors;                               		// 0x035C (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	float                                              MaxSeePlayerDistSq;                               		// 0x0368 (0x0004) [0x0000000000000000]              
	float                                              SeePlayerInterval;                                		// 0x036C (0x0004) [0x0000000000000001]              ( CPF_Edit )
	TArray< struct FBehaviorEntry >                    SpawnBehaviors;                                   		// 0x0370 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	TArray< struct FBehaviorEntry >                    UneasyBehaviors;                                  		// 0x037C (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	TArray< struct FBehaviorEntry >                    AlertBehaviors;                                   		// 0x0388 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	TArray< struct FBehaviorEntry >                    PanicBehaviors;                                   		// 0x0394 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	TArray< struct FBehaviorEntry >                    RandomBehaviors;                                  		// 0x03A0 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	TArray< struct FBehaviorEntry >                    TakeDamageBehaviors;                              		// 0x03AC (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	float                                              RandomBehaviorInterval;                           		// 0x03B8 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              ForceUpdateTime;                                  		// 0x03BC (0x0004) [0x0000000000000000]              
	float                                              ReachThreshold;                                   		// 0x03C0 (0x0004) [0x0000000000000000]              
	TArray< struct FBehaviorEntry >                    GroupWaitingBehaviors;                            		// 0x03C4 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	float                                              DesiredGroupRadius;                               		// 0x03D0 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              DesiredGroupRadiusSq;                             		// 0x03D4 (0x0004) [0x0000000000000000]              
	float                                              MaxLOSLifeDistanceSq;                             		// 0x03D8 (0x0004) [0x0000000000000000]              
	class UGameCrowdSpawnerInterface*                  MySpawner;                                        		// 0x03DC (0x0008) [0x0000000000000000]              
	unsigned char                                      UnknownData00[ 0x4 ];                             		// 0x03E0 (0x0004) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
	struct FVector                                     SpawnOffset;                                      		// 0x03E4 (0x000C) [0x0000000000000000]              
	float                                              InitialLastRenderTime;                            		// 0x03F0 (0x0004) [0x0000000000000000]              
	struct FColor                                      DebugAgentColor;                                  		// 0x03F4 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	class AGameCrowdDestination*                       DebugSpawnDest;                                   		// 0x03F8 (0x0004) [0x0000000000000001]              ( CPF_Edit )
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 1339 );
...
public:
	...
	unsigned long                                      bAllowSkeletonUpdateChangeBasedOnTickResult : 1;  		// 0x0470 (0x0004) [0x0000000000000001] [0x00000002] ( CPF_Edit )
	unsigned long                                      bTickWhenNotVisible : 1;                          		// 0x0470 (0x0004) [0x0000000000000001] [0x00000004] ( CPF_Edit )
	unsigned long                                      bIsPlayingIdleAnimation : 1;                      		// 0x0470 (0x0004) [0x0000000000000000] [0x00000008] 
	unsigned long                                      bIsPlayingDeathAnimation : 1;                     		// 0x0470 (0x0004) [0x0000000000000000] [0x00000010] 
	unsigned long                                      bIsPlayingImportantAnimation : 1;                 		// 0x0470 (0x0004) [0x0000000000000000] [0x00000020] 
	unsigned long                                      bAnimateThisTick : 1;                             		// 0x0470 (0x0004) [0x0000000000000000] [0x00000040] 
	float                                              NotVisibleDisableTickTime;                        		// 0x0474 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              MaxAnimationDistance;                             		// 0x0478 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              MaxAnimationDistanceSq;                           		// 0x047C (0x0004) [0x0000000000000000]              
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 1340 );
...
{
public:
	class UStaticMeshComponent*                        Mesh;                                             		// 0x03FC (0x0004) [0x0000000004080009]              ( CPF_Edit | CPF_ExportObject | CPF_Component | CPF_EditInline )
	class UMaterialInstanceConstant*                   MeshColor;                                        		// 0x0400 (0x0004) [0x0000000000000001]              ( CPF_Edit )
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 1341 );
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 1342 );
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 1343 );
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 1344 );
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 1345 );
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 1346 );
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 1347 );
...
{
public:
	TArray< class AGameCrowdDestination* >             PotentialSpawnPoints;                             		// 0x021C (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 1348 );
...
{
public:
	unsigned long                                      bIsEnabled : 1;                                   		// 0x01F0 (0x0004) [0x0000000000000021] [0x00000001] ( CPF_Edit | CPF_Net )
	class UCylinderComponent*                          CylinderComponent;                                		// 0x01F4 (0x0004) [0x0000000004080009]              ( CPF_Edit | CPF_ExportObject | CPF_Component | CPF_EditInline )
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 1349 );
...
{
public:
	float                                              RadiusOfBehaviorEvent;                            		// 0x01F8 (0x0004) [0x0000000000004000]              ( CPF_Config )
	float                                              DurationOfBehaviorEvent;                          		// 0x01FC (0x0004) [0x0000000000004000]              ( CPF_Config )
	unsigned char                                      EventType;                                        		// 0x0200 (0x0001) [0x0000000000000001]              ( CPF_Edit )
	unsigned long                                      bRequireLOS : 1;                                  		// 0x0204 (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
	class AActor*                                      Initiator;                                        		// 0x0208 (0x0004) [0x0000000000000000]              
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 1350 );
...
{
public:
	struct FPointer                                    VfTable_IEditorLinkSelectionInterface;            		// 0x01F8 (0x0004) [0x0000000000801002]              ( CPF_Const | CPF_Native | CPF_NoExport )
	unsigned long                                      bKillWhenReached : 1;                             		// 0x01FC (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
	unsigned long                                      bAllowAsPreviousDestination : 1;                  		// 0x01FC (0x0004) [0x0000000000000001] [0x00000002] ( CPF_Edit )
	unsigned long                                      bAvoidWhenPanicked : 1;                           		// 0x01FC (0x0004) [0x0000000000000001] [0x00000004] ( CPF_Edit )
	unsigned long                                      bSkipBehaviorIfPanicked : 1;                      		// 0x01FC (0x0004) [0x0000000000000001] [0x00000008] ( CPF_Edit )
	unsigned long                                      bFleeDestination : 1;                             		// 0x01FC (0x0004) [0x0000000000000001] [0x00000010] ( CPF_Edit )
	unsigned long                                      bMustReachExactly : 1;                            		// 0x01FC (0x0004) [0x0000000000000001] [0x00000020] ( CPF_Edit )
	unsigned long                                      bHasRestrictions : 1;                             		// 0x01FC (0x0004) [0x0000000000000000] [0x00000040] 
	unsigned long                                      bAllowsSpawning : 1;                              		// 0x01FC (0x0004) [0x0000000000000001] [0x00000080] ( CPF_Edit )
	unsigned long                                      bAllowCloudSpawning : 1;                          		// 0x01FC (0x0004) [0x0000000000000001] [0x00000100] ( CPF_Edit )
	unsigned long                                      bAllowVisibleSpawning : 1;                        		// 0x01FC (0x0004) [0x0000000000000001] [0x00000200] ( CPF_Edit )
	unsigned long                                      bLineSpawner : 1;                                 		// 0x01FC (0x0004) [0x0000000000000001] [0x00000400] ( CPF_Edit )
	unsigned long                                      bSpawnAtEdge : 1;                                 		// 0x01FC (0x0004) [0x0000000000000001] [0x00000800] ( CPF_Edit )
	unsigned long                                      bSoftPerimeter : 1;                               		// 0x01FC (0x0004) [0x0000000000000001] [0x00001000] ( CPF_Edit )
	unsigned long                                      bIsVisible : 1;                                   		// 0x01FC (0x0004) [0x0000000000000000] [0x00002000] 
	unsigned long                                      bWillBeVisible : 1;                               		// 0x01FC (0x0004) [0x0000000000000000] [0x00004000] 
	unsigned long                                      bCanSpawnHereNow : 1;                             		// 0x01FC (0x0004) [0x0000000000000000] [0x00008000] 
	unsigned long                                      bIsBeyondSpawnDistance : 1;                       		// 0x01FC (0x0004) [0x0000000000000000] [0x00010000] 
	unsigned long                                      bAdjacentToVisibleNode : 1;                       		// 0x01FC (0x0004) [0x0000000000000000] [0x00020000] 
	unsigned long                                      bHasNavigationMesh : 1;                           		// 0x01FC (0x0004) [0x0000000000000000] [0x00040000] 
	TArray< class AGameCrowdDestination* >             NextDestinations;                                 		// 0x0200 (0x000C) [0x0000000000600001]              ( CPF_Edit | CPF_NeedCtorLink )
	class AGameCrowdDestinationQueuePoint*             QueueHead;                                        		// 0x020C (0x0004) [0x0000000000200001]              ( CPF_Edit )
	int                                                Capacity;                                         		// 0x0210 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              Frequency;                                        		// 0x0214 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	int                                                CustomerCount;                                    		// 0x0218 (0x0004) [0x0000000000000000]              
	TArray< class UClass* >                            SupportedAgentClasses;                            		// 0x021C (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	TArray< class UObject* >                           SupportedArchetypes;                              		// 0x0228 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	TArray< class UClass* >                            RestrictedAgentClasses;                           		// 0x0234 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	TArray< class UObject* >                           RestrictedArchetypes;                             		// 0x0240 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	float                                              ExactReachTolerance;                              		// 0x024C (0x0004) [0x0000000000000000]              
	struct FName                                       InteractionTag;                                   		// 0x0250 (0x0008) [0x0000000000000001]              ( CPF_Edit )
	float                                              InteractionDelay;                                 		// 0x0258 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	TArray< struct FBehaviorEntry >                    ReachedBehaviors;                                 		// 0x025C (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	class AGameCrowdAgent*                             AgentEnRoute;                                     		// 0x0268 (0x0004) [0x0000000000000000]              
	float                                              Priority;                                         		// 0x026C (0x0004) [0x0000000000000000]              
	float                                              LastSpawnTime;                                    		// 0x0270 (0x0004) [0x0000000000000000]              
	class AGameCrowdPopulationManager*                 MyPopMgr;                                         		// 0x0274 (0x0004) [0x0000000000002000]              ( CPF_Transient )
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 1351 );
...
{
public:
	class AGameCrowdDestinationQueuePoint*             NextQueuePosition;                                		// 0x01F8 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	class AGameCrowdInteractionPoint*                  PreviousQueuePosition;                            		// 0x01FC (0x0004) [0x0000000000000000]              
	class AGameCrowdAgent*                             QueuedAgent;                                      		// 0x0200 (0x0004) [0x0000000000000000]              
	class AGameCrowdDestination*                       QueueDestination;                                 		// 0x0204 (0x0004) [0x0000000000002000]              ( CPF_Transient )
	unsigned long                                      bClearingQueue : 1;                               		// 0x0208 (0x0004) [0x0000000000000000] [0x00000001] 
	unsigned long                                      bPendingAdvance : 1;                              		// 0x0208 (0x0004) [0x0000000000000000] [0x00000002] 
	float                                              AverageReactionTime;                              		// 0x020C (0x0004) [0x0000000000000001]              ( CPF_Edit )
	class UClass*                                      QueueBehaviorClass;                               		// 0x0210 (0x0004) [0x0000000000000000]              
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 1352 );
...
public:
	...
	struct FCrowdSpawnInfoItem                         CloudSpawnInfo;                                   		// 0x01F4 (0x007C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	TArray< struct FCrowdSpawnInfoItem >               ScriptedSpawnInfo;                                		// 0x0270 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	class AGameCrowdInfoVolume*                        ActiveCrowdInfoVolume;                            		// 0x027C (0x0004) [0x0000000000000000]              
	TArray< class AGameCrowdDestination* >             GlobalPotentialSpawnPoints;                       		// 0x0280 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	float                                              SplitScreenNumReduction;                          		// 0x028C (0x0004) [0x0000000000000000]              
	float                                              PlayerPositionPredictionTime;                     		// 0x0290 (0x0004) [0x0000000000000000]              
	float                                              HeadVisibilityOffset;                             		// 0x0294 (0x0004) [0x0000000000000000]              
	class UClass*                                      NavigationHandleClass;                            		// 0x0298 (0x0004) [0x0000000000000000]              
	class UNavigationHandle*                           NavigationHandle;                                 		// 0x029C (0x0004) [0x0000000000000000]              
	class AGameCrowdAgent*                             QueryingAgent;                                    		// 0x02A0 (0x0004) [0x0000000000000000]              
	TArray< struct FCrowdSpawnerPlayerInfo >           PlayerInfo;                                       		// 0x02A4 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	float                                              LastPlayerInfoUpdateTime;                         		// 0x02B0 (0x0004) [0x0000000000000000]              
	unsigned long                                      bDebugSpawns : 1;                                 		// 0x02B4 (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
	unsigned long                                      bPauseCrowd : 1;                                  		// 0x02B4 (0x0004) [0x0000000000000001] [0x00000002] ( CPF_Edit )
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 1353 );
...
{
public:
	class USeqAct_GameCrowdSpawner*                    Spawner;                                          		// 0x01F0 (0x0004) [0x0000000000000020]              ( CPF_Net )
	unsigned long                                      bSpawningActive : 1;                              		// 0x01F4 (0x0004) [0x0000000000000020] [0x00000001] ( CPF_Net )
	int                                                DestroyAllCount;                                  		// 0x01F8 (0x0004) [0x0000000000000020]              ( CPF_Net )
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 1354 );
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 1355 );
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 1356 );
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 1357 );
...
{
public:
	unsigned long                                      bHasExploded : 1;                                 		// 0x01F0 (0x0004) [0x0000000000002000] [0x00000001] ( CPF_Transient )
	unsigned long                                      bExplodeMoreThanOnce : 1;                         		// 0x01F0 (0x0004) [0x0000000000000001] [0x00000002] ( CPF_Edit )
	unsigned long                                      bTrackExplosionParticleSystemLifespan : 1;        		// 0x01F0 (0x0004) [0x0000000000000000] [0x00000004] 
	unsigned long                                      bDrawDebug : 1;                                   		// 0x01F0 (0x0004) [0x0000000000000000] [0x00000008] 
	class UPointLightComponent*                        ExplosionLight;                                   		// 0x01F4 (0x0004) [0x0000000004082008]              ( CPF_ExportObject | CPF_Transient | CPF_Component | CPF_EditInline )
	...
	float                                              LightFadeTime;                                    		// 0x01FC (0x0004) [0x0000000000002000]              ( CPF_Transient )
	float                                              LightFadeTimeRemaining;                           		// 0x0200 (0x0004) [0x0000000000002000]              ( CPF_Transient )
	float                                              LightInitialBrightness;                           		// 0x0204 (0x0004) [0x0000000000002000]              ( CPF_Transient )
	float                                              RadialBlurFadeTime;                               		// 0x0208 (0x0004) [0x0000000000002000]              ( CPF_Transient )
	float                                              RadialBlurFadeTimeRemaining;                      		// 0x020C (0x0004) [0x0000000000002000]              ( CPF_Transient )
	float                                              RadialBlurMaxBlurAmount;                          		// 0x0210 (0x0004) [0x0000000000002000]              ( CPF_Transient )
	class UGameExplosion*                              ExplosionTemplate;                                		// 0x0214 (0x0004) [0x0000000000000000]              
	class URB_RadialImpulseComponent*                  RadialImpulseComponent;                           		// 0x0218 (0x0004) [0x0000000004080008]              ( CPF_ExportObject | CPF_Component | CPF_EditInline )
	class AController*                                 InstigatorController;                             		// 0x021C (0x0004) [0x0000000000000000]              
	class AActor*                                      HitActorFromPhysMaterialTrace;                    		// 0x0220 (0x0004) [0x0000000000000000]              
	struct FVector                                     HitLocationFromPhysMaterialTrace;                 		// 0x0224 (0x000C) [0x0000000000000000]              
	class AActor*                                      Attachee;                                         		// 0x0230 (0x0004) [0x0000000000000000]              
	class AController*                                 AttacheeController;                               		// 0x0234 (0x0004) [0x0000000000000000]              
	float                                              DirectionalExplosionMinDot;                       		// 0x0238 (0x0004) [0x0000000000002000]              ( CPF_Transient )
	struct FVector                                     ExplosionDirection;                               		// 0x023C (0x000C) [0x0000000000002020]              ( CPF_Net | CPF_Transient )
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 1358 );
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 1359 );
...
{
public:
	struct FName                                       PrimaryKey;                                       		// 0x05C4 (0x0008) [0x0000000000044000]              ( CPF_Config | CPF_GlobalConfig )
	struct FName                                       SecondaryKey;                                     		// 0x05CC (0x0008) [0x0000000000044000]              ( CPF_Config | CPF_GlobalConfig )
	struct FName                                       UnselectKey;                                      		// 0x05D4 (0x0008) [0x0000000000044000]              ( CPF_Config | CPF_GlobalConfig )
	unsigned long                                      bShowSelectedInfo : 1;                            		// 0x05DC (0x0004) [0x0000000000044000] [0x00000001] ( CPF_Config | CPF_GlobalConfig )
	unsigned long                                      bDrawDebugText : 1;                               		// 0x05DC (0x0004) [0x0000000000000000] [0x00000002] 
	unsigned long                                      bIsFrozenRendering : 1;                           		// 0x05DC (0x0004) [0x0000000000000000] [0x00000004] 
	class UClass*                                      HUDClass;                                         		// 0x05E0 (0x0004) [0x0000000000000000]              
	class APlayerController*                           OriginalControllerRef;                            		// 0x05E4 (0x0004) [0x0000000000000000]              
	class UPlayer*                                     OriginalPlayer;                                   		// 0x05E8 (0x0004) [0x0000000000000000]              
	class UDrawFrustumComponent*                       DrawFrustum;                                      		// 0x05EC (0x0004) [0x0000000004080008]              ( CPF_ExportObject | CPF_Component | CPF_EditInline )
	class AActor*                                      SelectedActor;                                    		// 0x05F0 (0x0004) [0x0000000000000000]              
	class UPrimitiveComponent*                         SelectedComponent;                                		// 0x05F4 (0x0004) [0x0000000004080008]              ( CPF_ExportObject | CPF_Component | CPF_EditInline )
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 1360 );
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 1361 );
...
{
public:
	unsigned long                                      bShowGameHud : 1;                                 		// 0x0478 (0x0004) [0x0000000000004000] [0x00000001] ( CPF_Config )
	unsigned long                                      bShowMobileHud : 1;                               		// 0x0478 (0x0004) [0x0000000000004000] [0x00000002] ( CPF_Config )
	unsigned long                                      bForceMobileHUD : 1;                              		// 0x0478 (0x0004) [0x0000000000044000] [0x00000004] ( CPF_Config | CPF_GlobalConfig )
	unsigned long                                      bShowMobileTilt : 1;                              		// 0x0478 (0x0004) [0x0000000000004000] [0x00000008] ( CPF_Config )
	unsigned long                                      bDebugTouches : 1;                                		// 0x0478 (0x0004) [0x0000000000004000] [0x00000010] ( CPF_Config )
	unsigned long                                      bDebugZones : 1;                                  		// 0x0478 (0x0004) [0x0000000000004000] [0x00000020] ( CPF_Config )
	unsigned long                                      bDebugZonePresses : 1;                            		// 0x0478 (0x0004) [0x0000000000004000] [0x00000040] ( CPF_Config )
	unsigned long                                      bShowMotionDebug : 1;                             		// 0x0478 (0x0004) [0x0000000000004000] [0x00000080] ( CPF_Config )
	class UTexture2D*                                  JoystickBackground;                               		// 0x047C (0x0004) [0x0000000000000000]              
	struct FTextureUVs                                 JoystickBackgroundUVs;                            		// 0x0480 (0x0010) [0x0000000000000000]              
	class UTexture2D*                                  JoystickHat;                                      		// 0x0490 (0x0004) [0x0000000000000000]              
	struct FTextureUVs                                 JoystickHatUVs;                                   		// 0x0494 (0x0010) [0x0000000000000000]              
	class UTexture2D*                                  ButtonImages[ 0x2 ];                              		// 0x04A4 (0x0008) [0x0000000000000000]              
	struct FTextureUVs                                 ButtonUVs[ 0x2 ];                                 		// 0x04AC (0x0020) [0x0000000000000000]              
	class UFont*                                       ButtonFont;                                       		// 0x04CC (0x0004) [0x0000000000000000]              
	struct FColor                                      ButtonCaptionColor;                               		// 0x04D0 (0x0004) [0x0000000000000000]              
	class UTexture2D*                                  TrackballBackground;                              		// 0x04D4 (0x0004) [0x0000000000000000]              
	struct FTextureUVs                                 TrackballBackgroundUVs;                           		// 0x04D8 (0x0010) [0x0000000000000000]              
	class UTexture2D*                                  TrackballTouchIndicator;                          		// 0x04E8 (0x0004) [0x0000000000000000]              
	struct FTextureUVs                                 TrackballTouchIndicatorUVs;                       		// 0x04EC (0x0010) [0x0000000000000000]              
	class UTexture2D*                                  SliderImages[ 0x4 ];                              		// 0x04FC (0x0010) [0x0000000000000000]              
	struct FTextureUVs                                 SliderUVs[ 0x4 ];                                 		// 0x050C (0x0040) [0x0000000000000000]              
	float                                              MobileTiltX;                                      		// 0x054C (0x0004) [0x0000000000004000]              ( CPF_Config )
	float                                              MobileTiltY;                                      		// 0x0550 (0x0004) [0x0000000000004000]              ( CPF_Config )
	float                                              MobileTiltSize;                                   		// 0x0554 (0x0004) [0x0000000000004000]              ( CPF_Config )
	TArray< class USeqEvent_HudRender* >               KismetRenderEvents;                               		// 0x0558 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 1362 );
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 1363 );
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 1364 );
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 1365 );
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 1366 );
...
// 0x0238 (0x04AC - 0x0274)
class UMobilePlayerInput : public UPlayerInput
{
public:
	struct FTouchData                                  Touches[ 0x5 ];                                   		// 0x0274 (0x0168) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	class UMobileMenuObject*                           InteractiveObject;                                		// 0x03DC (0x0004) [0x0000000000000000]              
	struct FDouble                                     InteractiveObjectLastTime;                        		// 0x03E0 (0x0008) [0x0000000000000000]              
	TArray< struct FMobileInputGroup >                 MobileInputGroups;                                		// 0x03E8 (0x000C) [0x0000000004400001]              ( CPF_Edit | CPF_NeedCtorLink | CPF_EditInline )
	int                                                CurrentMobileGroup;                               		// 0x03F4 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	TArray< class UMobileInputZone* >                  MobileInputZones;                                 		// 0x03F8 (0x000C) [0x0000000004400001]              ( CPF_Edit | CPF_NeedCtorLink | CPF_EditInline )
	TArray< struct FMobileInputZoneClassMap >          MobileInputZoneClasses;                           		// 0x0404 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	float                                              MobilePitch;                                      		// 0x0410 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              MobilePitchCenter;                                		// 0x0414 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              MobilePitchMultiplier;                            		// 0x0418 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              MobileYaw;                                        		// 0x041C (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              MobileYawCenter;                                  		// 0x0420 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              MobileYawMultiplier;                              		// 0x0424 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              MobilePitchDeadzoneSize;                          		// 0x0428 (0x0004) [0x0000000000004001]              ( CPF_Edit | CPF_Config )
	float                                              MobileYawDeadzoneSize;                            		// 0x042C (0x0004) [0x0000000000004001]              ( CPF_Edit | CPF_Config )
	float                                              MobileDoubleTapTime;                              		// 0x0430 (0x0004) [0x0000000000004001]              ( CPF_Edit | CPF_Config )
	float                                              MobileMinHoldForTap;                              		// 0x0434 (0x0004) [0x0000000000004001]              ( CPF_Edit | CPF_Config )
	float                                              MobileTapRepeatTime;                              		// 0x0438 (0x0004) [0x0000000000004001]              ( CPF_Edit | CPF_Config )
	unsigned long                                      bAllowTouchesInCinematic : 1;                     		// 0x043C (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
	unsigned long                                      bDisableTouchInput : 1;                           		// 0x043C (0x0004) [0x0000000000000001] [0x00000002] ( CPF_Edit )
	unsigned long                                      bAbsoluteTouchLocations : 1;                      		// 0x043C (0x0004) [0x0000000000004001] [0x00000004] ( CPF_Edit | CPF_Config )
	unsigned long                                      bCollapseTouchInput : 1;                          		// 0x043C (0x0004) [0x0000000000004001] [0x00000008] ( CPF_Edit | CPF_Config )
	unsigned long                                      bFakeMobileTouches : 1;                           		// 0x043C (0x0004) [0x0000000000000001] [0x00000010] ( CPF_Edit )
	unsigned long                                      bDisableSceneRender : 1;                          		// 0x043C (0x0004) [0x0000000000000001] [0x00000020] ( CPF_Edit )
	float                                              ZoneTimeout;                                      		// 0x0440 (0x0004) [0x0000000000004001]              ( CPF_Edit | CPF_Config )
	TArray< class UMobileMenuScene* >                  MobileMenuStack;                                  		// 0x0444 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	struct FString                                     NativeDebugString;                                		// 0x0450 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	float                                              MobileInactiveTime;                               		// 0x045C (0x0004) [0x0000000000000001]              ( CPF_Edit )
	TArray< class USeqEvent_MobileBase* >              MobileSeqEventHandlers;                           		// 0x0460 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	TArray< class USeqEvent_MobileRawInput* >          MobileRawInputSeqEventHandlers;                   		// 0x046C (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	struct FVector2D                                   MobileViewportOffset;                             		// 0x0478 (0x0008) [0x0000000000000000]              
	struct FVector2D                                   MobileViewportSize;                               		// 0x0480 (0x0008) [0x0000000000000000]              
	struct FScriptDelegate                             __OnTouchNotHandledInMenu__Delegate;              		// 0x0488 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FScriptDelegate                             __OnPreviewTouch__Delegate;                       		// 0x0494 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FScriptDelegate                             __OnInputTouch__Delegate;                         		// 0x04A0 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 1367 );
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 1368 );
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 1369 );
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 1370 );
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 1371 );
...
{
public:
	struct FString                                     MovieName;                                        		// 0x00D8 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	int                                                StartOfRenderingMovieFrame;                       		// 0x00E4 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	int                                                EndOfRenderingMovieFrame;                         		// 0x00E8 (0x0004) [0x0000000000000001]              ( CPF_Edit )
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 1372 );
...
{
public:
	float                                              ScreenX;                                          		// 0x00C4 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              ScreenY;                                          		// 0x00C8 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              TraceDistance;                                    		// 0x00CC (0x0004) [0x0000000000000001]              ( CPF_Edit )
	class UObject*                                     HitObject;                                        		// 0x00D0 (0x0004) [0x0000000000000000]              
	struct FVector                                     HitLocation;                                      		// 0x00D4 (0x000C) [0x0000000000000000]              
	struct FVector                                     HitNormal;                                        		// 0x00E0 (0x000C) [0x0000000000000000]              
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 1373 );
...
{
public:
	float                                              WarmupPopulationPct;                              		// 0x00C4 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	class UGameCrowd_ListOfAgents*                     CrowdAgentList;                                   		// 0x00C8 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	unsigned long                                      bClearOldArchetypes : 1;                          		// 0x00CC (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
	unsigned long                                      bEnableCrowdLightEnvironment : 1;                 		// 0x00CC (0x0004) [0x0000000000000001] [0x00000002] ( CPF_Edit )
	unsigned long                                      bCastShadows : 1;                                 		// 0x00CC (0x0004) [0x0000000000000001] [0x00000004] ( CPF_Edit )
	unsigned long                                      bFillPotentialSpawnPoints : 1;                    		// 0x00CC (0x0004) [0x0000000000000000] [0x00000008] 
	unsigned long                                      bForceObstacleChecking : 1;                       		// 0x00CC (0x0004) [0x0000000000000001] [0x00000010] ( CPF_Edit )
	unsigned long                                      bForceNavMeshPathing : 1;                         		// 0x00CC (0x0004) [0x0000000000000001] [0x00000020] ( CPF_Edit )
	unsigned long                                      bIndividualSpawner : 1;                           		// 0x00CC (0x0004) [0x0000000000000000] [0x00000040] 
	int                                                MaxAgents;                                        		// 0x00D0 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              SpawnRate;                                        		// 0x00D4 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	struct FLightingChannelContainer                   AgentLightingChannel;                             		// 0x00D8 (0x0004) [0x0000000000000000]              
	float                                              MaxSpawnDist;                                     		// 0x00DC (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              MinBehindSpawnDist;                               		// 0x00E0 (0x0004) [0x0000000000000000]              
	TArray< class AGameCrowdDestination* >             PotentialSpawnPoints;                             		// 0x00E4 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	float                                              AgentWarmupTime;                                  		// 0x00F0 (0x0004) [0x0000000000000000]              
	int                                                NumAgentsToTickPerFrame;                          		// 0x00F4 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	TArray< class AGameCrowdAgent* >                   LastSpawnedList;                                  		// 0x00F8 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 1374 );
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 1375 );
...
{
public:
	struct FName                                       ZoneName;                                         		// 0x00C4 (0x0008) [0x0000000000000001]              ( CPF_Edit )
	class UMobileInputZone*                            NewZone;                                          		// 0x00CC (0x0004) [0x0000000004000001]              ( CPF_Edit | CPF_EditInline )
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 1376 );
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 1377 );
...
{
public:
	struct FString                                     ZoneName;                                         		// 0x00C4 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 1378 );
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 1379 );
...
{
public:
	TArray< struct FPropertyInfo >                     Properties;                                       		// 0x00C4 (0x000C) [0x0000000004400001]              ( CPF_Edit | CPF_NeedCtorLink | CPF_EditInline )
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 1380 );
...
{
public:
	TArray< struct FName >                             AnimationList;                                    		// 0x00D8 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	float                                              BlendInTime;                                      		// 0x00E4 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              BlendOutTime;                                     		// 0x00E8 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	unsigned long                                      bUseRootMotion : 1;                               		// 0x00EC (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
	unsigned long                                      bFaceActionTargetFirst : 1;                       		// 0x00EC (0x0004) [0x0000000000000001] [0x00000002] ( CPF_Edit )
	unsigned long                                      bLooping : 1;                                     		// 0x00EC (0x0004) [0x0000000000000001] [0x00000004] ( CPF_Edit )
	unsigned long                                      bBlendBetweenAnims : 1;                           		// 0x00EC (0x0004) [0x0000000000000001] [0x00000008] ( CPF_Edit )
	int                                                LoopIndex;                                        		// 0x00F0 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              LoopTime;                                         		// 0x00F4 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	class AActor*                                      ActionTarget;                                     		// 0x00F8 (0x0004) [0x0000000000000000]              
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 1381 );
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 1382 );
...
public:
	...
	unsigned long                                      bIsActive : 1;                                    		// 0x00E8 (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
	float                                              AuthoredGlobalScale;                              		// 0x00EC (0x0004) [0x0000000000000001]              ( CPF_Edit )
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 1383 );
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 1384 );
...
{
public:
	float                                              Roll;                                             		// 0x00DC (0x0004) [0x0000000000000000]              
	float                                              Pitch;                                            		// 0x00E0 (0x0004) [0x0000000000000000]              
	float                                              Yaw;                                              		// 0x00E4 (0x0004) [0x0000000000000000]              
	float                                              DeltaRoll;                                        		// 0x00E8 (0x0004) [0x0000000000000000]              
	float                                              DeltaPitch;                                       		// 0x00EC (0x0004) [0x0000000000000000]              
	float                                              DeltaYaw;                                         		// 0x00F0 (0x0004) [0x0000000000000000]              
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 1385 );
...
{
public:
	struct FString                                     TargetZoneName;                                   		// 0x00DC (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 1386 );
...
{
public:
	unsigned long                                      bWasActiveLastFrame : 1;                          		// 0x00E8 (0x0004) [0x0000000000000000] [0x00000001] 
	unsigned long                                      bSendPressedOnlyOnTouchDown : 1;                  		// 0x00E8 (0x0004) [0x0000000000000001] [0x00000002] ( CPF_Edit )
	unsigned long                                      bSendPressedOnlyOnTouchUp : 1;                    		// 0x00E8 (0x0004) [0x0000000000000001] [0x00000004] ( CPF_Edit )
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 1387 );
...
{
public:
	float                                              XAxisValue;                                       		// 0x00E8 (0x0004) [0x0000000000000000]              
	float                                              YAxisValue;                                       		// 0x00EC (0x0004) [0x0000000000000000]              
	float                                              CenterX;                                          		// 0x00F0 (0x0004) [0x0000000000000000]              
	float                                              CenterY;                                          		// 0x00F4 (0x0004) [0x0000000000000000]              
	float                                              CurrentX;                                         		// 0x00F8 (0x0004) [0x0000000000000000]              
	float                                              CurrentY;                                         		// 0x00FC (0x0004) [0x0000000000000000]              
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 1388 );
...
{
public:
	float                                              Yaw;                                              		// 0x00E8 (0x0004) [0x0000000000000000]              
	float                                              StickStrength;                                    		// 0x00EC (0x0004) [0x0000000000000000]              
	struct FVector                                     RotationVector;                                   		// 0x00F0 (0x000C) [0x0000000000000000]              
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 1389 );
...
{
public:
	int                                                TouchIndex;                                       		// 0x00DC (0x0004) [0x0000000000000001]              ( CPF_Edit )
	int                                                TouchpadIndex;                                    		// 0x00E0 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              TouchLocationX;                                   		// 0x00E4 (0x0004) [0x0000000000000000]              
	float                                              TouchLocationY;                                   		// 0x00E8 (0x0004) [0x0000000000000000]              
	float                                              TimeStamp;                                        		// 0x00EC (0x0004) [0x0000000000000000]              
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 1390 );
...
public:
	...
	unsigned long                                      bCheckonTouch : 1;                                		// 0x00F4 (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
	struct FVector                                     FinalTouchLocation;                               		// 0x00F8 (0x000C) [0x0000000000000000]              
	struct FVector                                     FinalTouchNormal;                                 		// 0x0104 (0x000C) [0x0000000000000000]              
	class UObject*                                     FinalTouchObject;                                 		// 0x0110 (0x0004) [0x0000000000000000]              
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 1391 );
...
{
public:
	float                                              Tolerance;                                        		// 0x00F0 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              MinDistance;                                      		// 0x00F4 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	struct FVector2D                                   InitialTouch;                                     		// 0x00F8 (0x0008) [0x0000000000000000]              
	TArray< class AActor* >                            TouchedActors;                                    		// 0x0100 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	float                                              TraceDistance;                                    		// 0x010C (0x0004) [0x0000000000000001]              ( CPF_Edit )
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 1392 );
...
public:
	...
	unsigned long                                      m_bBlendIn : 1;                                   		// 0x009C (0x0004) [0x0000000000000001] [0x00000010] ( CPF_Edit )
	...
	float                                              m_bBlendInRemainingTime;                          		// 0x0118 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	struct FVector                                     m_BlendLoc;                                       		// 0x011C (0x000C) [0x0000000000002000]              ( CPF_Transient )
	struct FRotator                                    m_BlendRot;                                       		// 0x0128 (0x000C) [0x0000000000002000]              ( CPF_Transient )
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 1393 );
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 1394 );
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 1395 );
...
// 0x0074 (0x0580 - 0x050C)
class AGamePlayerCamera : public ACamera
{
public:
	class UGameCameraBase*                             ThirdPersonCam;                                   		// 0x050C (0x0004) [0x0000000004002001]              ( CPF_Edit | CPF_Transient | CPF_EditInline )
	class UClass*                                      ThirdPersonCameraClass;                           		// 0x0510 (0x0004) [0x0000000000000003]              ( CPF_Edit | CPF_Const )
	class UGameCameraBase*                             FixedCam;                                         		// 0x0514 (0x0004) [0x0000000004002001]              ( CPF_Edit | CPF_Transient | CPF_EditInline )
	class UClass*                                      FixedCameraClass;                                 		// 0x0518 (0x0004) [0x0000000000000003]              ( CPF_Edit | CPF_Const )
	class UGameCameraBase*                             CurrentCamera;                                    		// 0x051C (0x0004) [0x0000000004002001]              ( CPF_Edit | CPF_Transient | CPF_EditInline )
	unsigned long                                      bUseForcedCamFOV : 1;                             		// 0x0520 (0x0004) [0x0000000000002000] [0x00000001] ( CPF_Transient )
	unsigned long                                      bInterpolateCamChanges : 1;                       		// 0x0520 (0x0004) [0x0000000000002000] [0x00000002] ( CPF_Transient )
	unsigned long                                      bResetInterp : 1;                                 		// 0x0520 (0x0004) [0x0000000000002000] [0x00000004] ( CPF_Transient )
	float                                              ForcedCamFOV;                                     		// 0x0524 (0x0004) [0x0000000000002000]              ( CPF_Transient )
	class AActor*                                      LastViewTarget;                                   		// 0x0528 (0x0004) [0x0000000000002000]              ( CPF_Transient )
	float                                              SplitScreenShakeScale;                            		// 0x052C (0x0004) [0x0000000000000003]              ( CPF_Edit | CPF_Const )
	class AActor*                                      LastTargetBase;                                   		// 0x0530 (0x0004) [0x0000000000002000]              ( CPF_Transient )
	unsigned char                                      UnknownData00[ 0xC ];                             		// 0x0534 (0x000C) MISSED OFFSET
	struct FMatrix                                     LastTargetBaseTM;                                 		// 0x0540 (0x0040) [0x0000000000002000]              ( CPF_Transient )
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 1396 );
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 1397 );
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 1398 );
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 1399 );
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 1400 );
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 1401 );
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 42003 );
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 42022 );
...
{
public:
	unsigned long                                      bDrawDebugText : 1;                               		// 0x0478 (0x0004) [0x0000000000000000] [0x00000001] 
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 42093 );
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 42126 );
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 42316 );
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 42533 );
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 42534 );
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 42640 );
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 42686 );
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 42905 );
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 43359 );
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 43691 );
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 43712 );
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 43723 );
...
{
public:
	int                                                OldMobileGroup;                                   		// 0x05F8 (0x0004) [0x0000000000000000]              
	class UMobilePlayerInput*                          MPI;                                              		// 0x05FC (0x0004) [0x0000000000000000]              
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 44262 );
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 44268 );
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 44269 );
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 44824 );
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 44827 );
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 44877 );
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 44902 );
...
{
public:
	class UClass*                                      InitialSceneToDisplayClass;                       		// 0x039C (0x0004) [0x0000000000000000]              
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 44919 );
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 44928 );
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 44944 );
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 45050 );
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 45069 );
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 45211 );
...
{
public:
	unsigned long                                      bEnabled : 1;                                     		// 0x021C (0x0004) [0x0000000000000000] [0x00000001] 
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 45305 );
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 45310 );
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 45315 );
...
// 0x0010 (0x03AC - 0x039C)
class APlayerCollectorGame : public AGameInfo
{
public:
	int                                                NumberOfClientsToWaitFor;                         		// 0x039C (0x0004) [0x0000000000000000]              
	struct FString                                     URLToLoad;                                        		// 0x03A0 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 45341 );

		return pClassPointer;
	};

	void eventGetSeamlessTravelActorList ( unsigned long bToEntry, TArray< class AActor* >* ActorList );
	class APlayerController* eventLogin ( struct FString Portal, struct FString Options, struct FUniqueNetId UniqueId, struct FUniqueNetId ConsoleUniqueId, struct FString* ErrorMessage );
};
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 45357 );
...
{
public:
	struct FLinearColor                                DisplayColor;                                     		// 0x00F0 (0x0010) [0x0000000000000001]              ( CPF_Edit )
	struct FVector                                     DisplayLocation;                                  		// 0x0100 (0x000C) [0x0000000000000001]              ( CPF_Edit )
	class UTexture2D*                                  DisplayTexture;                                   		// 0x010C (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              XL;                                               		// 0x0110 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              YL;                                               		// 0x0114 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              U;                                                		// 0x0118 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              V;                                                		// 0x011C (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              UL;                                               		// 0x0120 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              VL;                                               		// 0x0124 (0x0004) [0x0000000000000001]              ( CPF_Edit )
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 45440 );
...
{
public:
	class UFont*                                       DisplayFont;                                      		// 0x00F0 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	struct FColor                                      DisplayColor;                                     		// 0x00F4 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	struct FVector                                     DisplayLocation;                                  		// 0x00F8 (0x000C) [0x0000000000000001]              ( CPF_Edit )
	struct FString                                     DisplayText;                                      		// 0x0104 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	unsigned char                                      TextDrawMethod;                                   		// 0x0110 (0x0001) [0x0000000000000001]              ( CPF_Edit )
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 45460 );
