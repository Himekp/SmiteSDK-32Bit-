...
{
	TArray< struct FUniqueNetId >                      Users;                                            		// 0x0000 (0x000C) [0x0000000000400080]              ( CPF_Parm | CPF_NeedCtorLink )
...
struct UVivoxOSSConnectors_eventCanCommunicateVoice_Parms
{
	...
	// class UVivoxClosureOnPrivilegeLevelChecked*     Closure;                                          		// 0x000C (0x0004) [0x0000000000000000]              
};
...
{
	class UVivoxClosure*                               Closure;                                          		// 0x0000 (0x0004) [0x0000000000000080]              ( CPF_Parm )
};
...
{
	class UOnlineSubsystem*                            OnlineSub;                                        		// 0x0000 (0x0004) [0x0000000000000080]              ( CPF_Parm )
};
...
{
	class UVivoxOSSConnectors*                         ParamConnector;                                   		// 0x0000 (0x0004) [0x0000000000000080]              ( CPF_Parm )
};
...
{
	int                                                ChannelJoinCount;                                 		// 0x0000 (0x0004) [0x0000000000000080]              ( CPF_Parm )
	class UVivoxOSSConnectors*                         Connector;                                        		// 0x0004 (0x0004) [0x0000000000000080]              ( CPF_Parm )
};
