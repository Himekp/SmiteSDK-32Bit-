...
struct FItemData_GodPage
{
	...
	struct FString                                     sGoldLabel;                                       		// 0x005C (0x000C) [0x0000000000500000]              ( CPF_NeedCtorLink )
	struct FString                                     sName;                                            		// 0x0068 (0x000C) [0x0000000000500000]              ( CPF_NeedCtorLink )
	struct FString                                     sNameINT;                                         		// 0x0074 (0x000C) [0x0000000000500000]              ( CPF_NeedCtorLink )
	struct FString                                     sTags;                                            		// 0x0080 (0x000C) [0x0000000000500000]              ( CPF_NeedCtorLink )
	struct FString                                     sDescription;                                     		// 0x008C (0x000C) [0x0000000000500000]              ( CPF_NeedCtorLink )
	struct FString                                     sPantheon;                                        		// 0x0098 (0x000C) [0x0000000000500000]              ( CPF_NeedCtorLink )
	struct FString                                     sImageTexture;                                    		// 0x00A4 (0x000C) [0x0000000000500000]              ( CPF_NeedCtorLink )
	struct FString                                     sIconTexture;                                     		// 0x00B0 (0x000C) [0x0000000000500000]              ( CPF_NeedCtorLink )
	struct FPointer                                    pItem;                                            		// 0x00BC (0x0004) [0x0000000000001000]              ( CPF_Native )
	int                                                nObtainabilityLocation;                           		// 0x00C0 (0x0004) [0x0000000000000000]              
};
...
struct FStreamData_Gods
{
	...
	struct FString                                     streamURLGods;                                    		// 0x000C (0x000C) [0x0000000000500000]              ( CPF_NeedCtorLink )
	struct FString                                     streamLabelGods;                                  		// 0x0018 (0x000C) [0x0000000000500000]              ( CPF_NeedCtorLink )
};
...
struct FGFxSkinBtn
{
	...
	class UTgGFxObject*                                ObtainabilityIcon;                                		// 0x0034 (0x0004) [0x0000000000000000]              
};
...
struct FGFxItem
{
	class UTgGFxObject*                                pObj;                                             		// 0x0000 (0x0004) [0x0000000000000000]              
	class UTgGFxObject*                                Icon;                                             		// 0x0004 (0x0004) [0x0000000000000000]              
	class UTgGFxObject*                                MasterIcon;                                       		// 0x0008 (0x0004) [0x0000000000000000]              
	class UTgGFxObject*                                TagText;                                          		// 0x000C (0x0004) [0x0000000000000000]              
	class UTgGFxObject*                                GoldTag;                                          		// 0x0010 (0x0004) [0x0000000000000000]              
};
...
struct FNotifyData
{
	...
	struct FString                                     sSourceName;                                      		// 0x001C (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FString                                     sTargetName;                                      		// 0x0028 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FString                                     sAGodIconPath;                                    		// 0x0034 (0x000C) [0x0000000000500000]              ( CPF_NeedCtorLink )
	struct FString                                     sBGodIconPath;                                    		// 0x0040 (0x000C) [0x0000000000500000]              ( CPF_NeedCtorLink )
	unsigned long                                      bFriendly : 1;                                    		// 0x004C (0x0004) [0x0000000000000000] [0x00000001] 
	unsigned long                                      bFriendly2 : 1;                                   		// 0x004C (0x0004) [0x0000000000000000] [0x00000002] 
	int                                                nSkin;                                            		// 0x0050 (0x0004) [0x0000000000000000]              
	int                                                nGodA;                                            		// 0x0054 (0x0004) [0x0000000000000000]              
	int                                                nGodB;                                            		// 0x0058 (0x0004) [0x0000000000000000]              
	int                                                nGodAColored;                                     		// 0x005C (0x0004) [0x0000000000000000]              
	int                                                nGodBColored;                                     		// 0x0060 (0x0004) [0x0000000000000000]              
	unsigned char                                      AccoladeType;                                     		// 0x0064 (0x0001) [0x0000000000000000]              
	unsigned long                                      bKillStreakOrCombo : 1;                           		// 0x0068 (0x0004) [0x0000000000000000] [0x00000001] 
	int                                                nAccoladeIcon;                                    		// 0x006C (0x0004) [0x0000000000000000]              
	float                                              fExpireTime;                                      		// 0x0070 (0x0004) [0x0000000000000000]              
	float                                              fDurationOverride;                                		// 0x0074 (0x0004) [0x0000000000000000]              
	struct FString                                     sMessage;                                         		// 0x0078 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	int                                                nAlertType;                                       		// 0x0084 (0x0004) [0x0000000000000000]              
	int                                                nNotifyFill;                                      		// 0x0088 (0x0004) [0x0000000000000000]              
	int                                                nNotifyDelay;                                     		// 0x008C (0x0004) [0x0000000000000000]              
	int                                                nNotifyColor;                                     		// 0x0090 (0x0004) [0x0000000000000000]              
	int                                                nNotifySize;                                      		// 0x0094 (0x0004) [0x0000000000000000]              
};
...
struct FItemData_LoadoutsPage
{
	...
	struct FString                                     sDescription;                                     		// 0x0028 (0x000C) [0x0000000000500000]              ( CPF_NeedCtorLink )
	struct FString                                     sImagePath;                                       		// 0x0034 (0x000C) [0x0000000000500000]              ( CPF_NeedCtorLink )
};
...
struct FListPlayerData
{
	...
	struct FString                                     lpd_PlayerName;                                   		// 0x0010 (0x000C) [0x0000000000500000]              ( CPF_NeedCtorLink )
};
...
{
	class UTgGFxObject*                                pObj;                                             		// 0x0000 (0x0004) [0x0000000000000000]              
	class UTgGFxObject*                                MicrophoneIcon;                                   		// 0x0004 (0x0004) [0x0000000000000000]              
	class UTgGFxObject*                                Avatar;                                           		// 0x0008 (0x0004) [0x0000000000000000]              
	class UTgGFxObject*                                Pending;                                          		// 0x000C (0x0004) [0x0000000000000000]              
	class UTgGFxObject*                                SignificanceIcon;                                 		// 0x0010 (0x0004) [0x0000000000000000]              
};
...
struct FGFxTreasureItem
{
	...
	class UGFxObject*                                  treasureItemData;                                 		// 0x0008 (0x0004) [0x0000000000000000]              
};
