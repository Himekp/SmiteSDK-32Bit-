...
public:
	...
	TArray< struct FName >                             ForceGarbageCollectUponReleaseTextures;           		// 0x004C (0x000C) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 1435 );
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 1436 );
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 1437 );
...
public:
	...
	unsigned long                                      m_bIsMuted : 1;                                   		// 0x00C8 (0x0004) [0x0000000000000000] [0x04000000] 
	...
	struct FGFxStoredViewportParams                    m_StoredViewportParams;                           		// 0x015C (0x0014) [0x0000000000000000]              
...
public:
	...
	class UGFxObject* GetAS2ClassObject ( struct FString Path, class UClass* Type );
	class UGFxObject* GetAS3ClassObject ( struct FString Path, class UClass* Type );
	...
	int GetAVMVersion ( );
	bool eventShouldBlockKey ( int ControllerId, struct FName ButtonName, unsigned char InputEvent );
	bool eventFilterButtonInput ( int ControllerId, struct FName ButtonName, unsigned char InputEvent );
	bool NativeAllowButtonInput ( int ControllerId, struct FName ButtonName, unsigned char InputEvent );
...
public:
	...
	int                                                Value[ 0xC ];                                     		// 0x0040 (0x0030) [0x0000000000001002]              ( CPF_Const | CPF_Native )
	TArray< struct FGFxWidgetBinding >                 SubWidgetBindings;                                		// 0x0070 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	unsigned long                                      m_bHasCallbacksBound : 1;                         		// 0x007C (0x0004) [0x0000000000000000] [0x00000001] 
...
public:
	...
	unsigned long                                      bUseStreamableTextures : 1;                       		// 0x006C (0x0004) [0x0000000000000001] [0x00000010] ( CPF_Edit )
...
{
public:
	class UGFxMoviePlayer*                             Movie;                                            		// 0x00C4 (0x0004) [0x0000000000000000]              
	unsigned long                                      bUnload : 1;                                      		// 0x00C8 (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
...
public:
	class UGFxMoviePlayer*                             Movie;                                            		// 0x00C4 (0x0004) [0x0000000000000000]              
	struct FString                                     Variable;                                         		// 0x00C8 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
...
public:
	class UGFxMoviePlayer*                             Movie;                                            		// 0x00C4 (0x0004) [0x0000000000000000]              
	struct FString                                     MethodName;                                       		// 0x00C8 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	TArray< struct FASValue >                          Arguments;                                        		// 0x00D4 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
...
public:
	...
	class UClass*                                      MoviePlayerClass;                                 		// 0x00C8 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	class UGFxMoviePlayer*                             MoviePlayer;                                      		// 0x00CC (0x0004) [0x0000000000000000]              
	unsigned long                                      bTakeFocus : 1;                                   		// 0x00D0 (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
	unsigned long                                      bCaptureInput : 1;                                		// 0x00D0 (0x0004) [0x0000000000000001] [0x00000002] ( CPF_Edit )
	unsigned long                                      bStartPaused : 1;                                 		// 0x00D0 (0x0004) [0x0000000000000001] [0x00000004] ( CPF_Edit )
	unsigned long                                      bEnableGammaCorrection : 1;                       		// 0x00D0 (0x0004) [0x0000000000000000] [0x00000008] 
	unsigned long                                      bDisplayWithHudOff : 1;                           		// 0x00D0 (0x0004) [0x0000000000000001] [0x00000010] ( CPF_Edit )
	unsigned char                                      RenderTextureMode;                                		// 0x00D4 (0x0001) [0x0000000000000001]              ( CPF_Edit )
	class UTextureRenderTarget2D*                      RenderTexture;                                    		// 0x00D8 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	TArray< struct FName >                             CaptureKeys;                                      		// 0x00DC (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	TArray< struct FName >                             FocusIgnoreKeys;                                  		// 0x00E8 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
...
public:
	class UGFxMoviePlayer*                             Movie;                                            		// 0x00C4 (0x0004) [0x0000000000000000]              
	TArray< struct FName >                             CaptureKeys;                                      		// 0x00C8 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
...
{
public:
	class USwfMovie*                                   Movie;                                            		// 0x00DC (0x0004) [0x0000000000000001]              ( CPF_Edit )
	struct FString                                     FSCommand;                                        		// 0x00E0 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	class UGFxFSCmdHandler_Kismet*                     Handler;                                          		// 0x00EC (0x0004) [0x0000000000000000]              
...
public:
	...
	{
		if ( ! pClassPointer )
			pClassPointer = (UClass*) UObject::GObjObjects()->GetIndex( 37927 );
