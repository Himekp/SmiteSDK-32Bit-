...
public:
	...
	float                                              m_NextUpdateInSeconds;                            		// 0x0040 (0x0004) [0x0000000000000000]              
	int                                                m_nNextWrite;                                     		// 0x0044 (0x0004) [0x0000000000000000]              
	struct FString                                     m_fsBaseSeriesName;                               		// 0x0048 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FDataDogMetricsConfig                       m_Config;                                         		// 0x0054 (0x0050) [0x0000000000400000]              ( CPF_NeedCtorLink )
	unsigned char                                      UnknownData00[ 0x3C ];                            		// 0x00A4 (0x003C) UNKNOWN PROPERTY: MapProperty PlatformCommon.PComDataDogUploader.m_Metrics
	struct FPointer                                    DDUploadSyncObject;                               		// 0x00E0 (0x0004) [0x0000000000000000]              
...
UClass* UPComDataDogUploader::pClassPointer = NULL;

// Class PlatformCommon.PComGameEngine
// 0x0004 (0x07CC - 0x07C8)
class UPComGameEngine : public UGameEngine
{
public:
	struct FPointer                                    pOutgoingMarshal;                                 		// 0x07C8 (0x0004) [0x0000000000001002]              ( CPF_Const | CPF_Native )
...
public:
	...
	struct FString                                     m_strDownloadDir;                                 		// 0x0050 (0x000C) [0x0000000000500000]              ( CPF_NeedCtorLink )
	struct FString                                     m_strLocalDir;                                    		// 0x005C (0x000C) [0x0000000000500000]              ( CPF_NeedCtorLink )
	struct FString                                     m_strJson;                                        		// 0x0068 (0x000C) [0x0000000000500000]              ( CPF_NeedCtorLink )
	struct FString                                     m_strName;                                        		// 0x0074 (0x000C) [0x0000000000500000]              ( CPF_NeedCtorLink )
	struct FPointer                                    m_pHttp;                                          		// 0x0080 (0x0004) [0x0000000000001002]              ( CPF_Const | CPF_Native )
...
public:
	...
	struct FString                                     FacebookLiveUrl;                                  		// 0x0058 (0x000C) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
	unsigned char                                      CurrentState;                                     		// 0x0064 (0x0001) [0x0000000000002000]              ( CPF_Transient )
	struct FPComOpenBroadcasterSettings                CurrentSettings;                                  		// 0x0068 (0x0004) [0x0000000000002000]              ( CPF_Transient )
	struct FPointer                                    StreamerProcessHandle;                            		// 0x006C (0x0004) [0x0000000000002000]              ( CPF_Transient )
	struct FScriptDelegate                             __PreloadWebBrowser__Delegate;                    		// 0x0070 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FScriptDelegate                             __IsWebBrowserLoaded__Delegate;                   		// 0x007C (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FScriptDelegate                             __OpenWebBrowser__Delegate;                       		// 0x0088 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FScriptDelegate                             __CloseWebBrowser__Delegate;                      		// 0x0094 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
...
{
public:
	TArray< struct FName >                             StatsToCollect;                                   		// 0x003C (0x000C) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
	struct FArray_Mirror                               StatIds;                                          		// 0x0048 (0x000C) [0x0000000000003000]              ( CPF_Native | CPF_Transient )
	TArray< unsigned char >                            StatTypes;                                        		// 0x0054 (0x000C) [0x0000000000402000]              ( CPF_Transient | CPF_NeedCtorLink )
	float                                              FOV;                                              		// 0x0060 (0x0004) [0x0000000000004000]              ( CPF_Config )
	TArray< struct FPComPerformanceCaptureProfile >    Profiles;                                         		// 0x0064 (0x000C) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
	struct FPComPerformanceCaptureProfile              FallbackProfile;                                  		// 0x0070 (0x001C) [0x0000000000004000]              ( CPF_Config )
	struct FPComPerformanceCaptureProfile              ActiveProfile;                                    		// 0x008C (0x001C) [0x0000000000002000]              ( CPF_Transient )
...
{
public:
	class UPComPerformanceCaptureBase*                 BasePerformanceCapture;                           		// 0x039C (0x0004) [0x0000000000002000]              ( CPF_Transient )
	unsigned char                                      CurrentCaptureState;                              		// 0x03A0 (0x0001) [0x0000000000000000]              
	TArray< class APComPerformanceCaptureNode* >       NodesToCapture;                                   		// 0x03A4 (0x000C) [0x0000000000402000]              ( CPF_Transient | CPF_NeedCtorLink )
	TArray< struct FPComPerformanceCaptureStatsPerNode > StatsPerNode;                                     		// 0x03B0 (0x000C) [0x0000000000402000]              ( CPF_Transient | CPF_NeedCtorLink )
...
{
public:
	struct FString                                     ExecCommand;                                      		// 0x01F0 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	float                                              DelayBeforeCapture;                               		// 0x01FC (0x0004) [0x0000000000000001]              ( CPF_Edit )
...
public:
	struct FPointer                                    VfTable_FCallbackEventDevice;                     		// 0x003C (0x0004) [0x0000000000801002]              ( CPF_Const | CPF_Native | CPF_NoExport )
	class UPComPictureInPictureScene*                  Scene;                                            		// 0x0040 (0x0004) [0x0000000000000000]              
	class UTextureRenderTarget2D*                      RenderTargetToUse;                                		// 0x0044 (0x0004) [0x0000000000000000]              
	TArray< struct FPComPipViewDesc >                  ViewDescs;                                        		// 0x0048 (0x000C) [0x0000000000101000]              ( CPF_Native )
	unsigned long                                      bEnableDebugRendering : 1;                        		// 0x0054 (0x0004) [0x0000000000000000] [0x00000001] 
	struct FVector2D                                   CurrentOffset;                                    		// 0x0058 (0x0008) [0x0000000000000000]              
	struct FVector2D                                   CurrentScaling;                                   		// 0x0060 (0x0008) [0x0000000000000000]              
...
{
public:
	float                                              SkyBrightness;                                    		// 0x003C (0x0004) [0x0000000000000001]              ( CPF_Edit )
	struct FColor                                      SkyColor;                                         		// 0x0040 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              LightBrightness;                                  		// 0x0044 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	unsigned long                                      bAlwaysAllowAudioPlayback : 1;                    		// 0x0048 (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
	unsigned long                                      bForceAllUsedMipsResident : 1;                    		// 0x0048 (0x0004) [0x0000000000000001] [0x00000002] ( CPF_Edit )
	struct FPointer                                    Scene;                                            		// 0x004C (0x0004) [0x0000000000003000]              ( CPF_Native | CPF_Transient )
	TArray< class UActorComponent* >                   Components;                                       		// 0x0050 (0x000C) [0x0000000004480008]              ( CPF_ExportObject | CPF_Component | CPF_NeedCtorLink | CPF_EditInline )
	class UDirectionalLightComponent*                  DirectionalLight;                                 		// 0x005C (0x0004) [0x0000000004080008]              ( CPF_ExportObject | CPF_Component | CPF_EditInline )
	class UDirectionalLightComponent*                  DirectionalBounceLight;                           		// 0x0060 (0x0004) [0x0000000004080008]              ( CPF_ExportObject | CPF_Component | CPF_EditInline )
	class USkyLightComponent*                          SkyLight;                                         		// 0x0064 (0x0004) [0x0000000004080008]              ( CPF_ExportObject | CPF_Component | CPF_EditInline )
	class ULineBatchComponent*                         LineBatcher;                                      		// 0x0068 (0x0004) [0x0000000004080008]              ( CPF_ExportObject | CPF_Component | CPF_EditInline )
...
public:
	...
	unsigned long                                      m_bHasAcknowledgedPawn : 1;                       		// 0x05CC (0x0004) [0x0000000000002000] [0x00000010] ( CPF_Transient )
	unsigned long                                      m_bKeepLoggedIn : 1;                              		// 0x05CC (0x0004) [0x0000000000044000] [0x00000020] ( CPF_Config | CPF_GlobalConfig )
	struct Fdword                                      m_dwPendingPartyId;                               		// 0x05D0 (0x0004) [0x0000000000000000]              
	int                                                m_nMaxPartyPublicConnections;                     		// 0x05D4 (0x0004) [0x0000000000004000]              ( CPF_Config )
	struct FOnlineGameSearchResult                     m_PendingInviteResult;                            		// 0x05D8 (0x0008) [0x0000000000000000]              
	struct FName                                       PartySessionName;                                 		// 0x05E0 (0x0008) [0x0000000000000002]              ( CPF_Const )
	struct FName                                       GameSessionName;                                  		// 0x05E8 (0x0008) [0x0000000000000002]              ( CPF_Const )
	struct Fdword                                      m_dwLastLoginPortalId;                            		// 0x05F0 (0x0004) [0x0000000000044000]              ( CPF_Config | CPF_GlobalConfig )
	struct Fdword                                      m_dwLastLoginAccountId;                           		// 0x05F4 (0x0004) [0x0000000000044000]              ( CPF_Config | CPF_GlobalConfig )
	struct FString                                     m_sLastLoginAccessToken;                          		// 0x05F8 (0x000C) [0x0000000000444000]              ( CPF_Config | CPF_GlobalConfig | CPF_NeedCtorLink )
	struct FString                                     m_sLastLoginAccessTokenExpiration;                		// 0x0604 (0x000C) [0x0000000000444000]              ( CPF_Config | CPF_GlobalConfig | CPF_NeedCtorLink )
...
{
public:
	unsigned char                                      UnknownData00[ 0x3C ];                            		// 0x0274 (0x003C) UNKNOWN PROPERTY: MapProperty PlatformCommon.PComPlayerInput.m_KeyBindingMap
	unsigned long                                      c_bDirty : 1;                                     		// 0x02B0 (0x0004) [0x0000000000000000] [0x00000001] 
	unsigned long                                      c_bUseServerBindings : 1;                         		// 0x02B0 (0x0004) [0x0000000000004000] [0x00000002] ( CPF_Config )
	unsigned long                                      c_bJumpEnabled : 1;                               		// 0x02B0 (0x0004) [0x0000000000004000] [0x00000004] ( CPF_Config )
	unsigned long                                      m_bAllowSaveServerBindings : 1;                   		// 0x02B0 (0x0004) [0x0000000000000000] [0x00000008] 
	struct FString                                     c_sCurrentProfile;                                		// 0x02B4 (0x000C) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
	int                                                m_nKeybindConfigSet;                              		// 0x02C0 (0x0004) [0x0000000000000000]              
	float                                              m_nMinLookSensitivity;                            		// 0x02C4 (0x0004) [0x0000000000000000]              
	float                                              m_nMaxLookSensitivity;                            		// 0x02C8 (0x0004) [0x0000000000000000]              
	int                                                m_RecCastMode;                                    		// 0x02CC (0x0004) [0x0000000000000000]              
...
// 0x05A7 (0x05FC - 0x0055)
class UPComPositionHistoryServerComponent : public UActorComponent
{
public:
	int                                                CurrentIndex;                                     		// 0x0058 (0x0004) [0x0000000000000000]              
	float                                              ServerTimeStamps[ 0x1E ];                         		// 0x005C (0x0078) [0x0000000000000000]              
	float                                              ClientTimeStamps[ 0x1E ];                         		// 0x00D4 (0x0078) [0x0000000000000000]              
	struct FVector                                     Positions[ 0x1E ];                                		// 0x014C (0x0168) [0x0000000000000000]              
	struct FVector                                     Velocities[ 0x1E ];                               		// 0x02B4 (0x0168) [0x0000000000000000]              
	struct FRotator                                    Rotations[ 0x1E ];                                		// 0x041C (0x0168) [0x0000000000000000]              
	unsigned char                                      bJustTeleported[ 0x1E ];                          		// 0x0584 (0x001E) [0x0000000000000000]              
	unsigned char                                      bCollideActors[ 0x1E ];                           		// 0x05A2 (0x001E) [0x0000000000000000]              
	unsigned char                                      bBlockActors[ 0x1E ];                             		// 0x05C0 (0x001E) [0x0000000000000000]              
	unsigned char                                      Physics[ 0x1E ];                                  		// 0x05DE (0x001E) [0x0000000000000000]              
...
public:
	...
	unsigned long                                      m_bLocalLoad : 1;                                 		// 0x003C (0x0004) [0x0000000000000000] [0x00000002] 
...
// 0x0054 (0x0244 - 0x01F0)
class APComVideoPlayer : public AActor
{
public:
	struct FString                                     VideoURL;                                         		// 0x01F0 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	int                                                Width;                                            		// 0x01FC (0x0004) [0x0000000000000001]              ( CPF_Edit )
	int                                                Height;                                           		// 0x0200 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              Volume;                                           		// 0x0204 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	unsigned long                                      bAutoResize : 1;                                  		// 0x0208 (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
	unsigned long                                      bConstrainAspectRatio : 1;                        		// 0x0208 (0x0004) [0x0000000000000001] [0x00000002] ( CPF_Edit )
	unsigned long                                      bDebugRender : 1;                                 		// 0x0208 (0x0004) [0x0000000000000001] [0x00000004] ( CPF_Edit )
	unsigned long                                      bVideoFinished : 1;                               		// 0x0208 (0x0004) [0x0000000000002000] [0x00000008] ( CPF_Transient )
	unsigned long                                      bOnVideoFinishedIssued : 1;                       		// 0x0208 (0x0004) [0x0000000000002000] [0x00000010] ( CPF_Transient )
	unsigned long                                      bHasMinorStreamingProblem : 1;                    		// 0x0208 (0x0004) [0x0000000000002000] [0x00000020] ( CPF_Transient )
	float                                              ConstrainedAspectRatio;                           		// 0x020C (0x0004) [0x0000000000000001]              ( CPF_Edit )
	struct FPointer                                    Resource;                                         		// 0x0210 (0x0004) [0x0000000000003000]              ( CPF_Native | CPF_Transient )
	class UTextureRenderTarget2D*                      RenderTargetToUse;                                		// 0x0214 (0x0004) [0x0000000000002000]              ( CPF_Transient )
	class UTextureRenderTarget2D*                      TextureCopyForStreamingProblem;                   		// 0x0218 (0x0004) [0x0000000000002000]              ( CPF_Transient )
	float                                              TimeSinceMinorStreamingProblem;                   		// 0x021C (0x0004) [0x0000000000002000]              ( CPF_Transient )
	class UMaterial*                                   StreamingProblemMaterial;                         		// 0x0220 (0x0004) [0x0000000000002000]              ( CPF_Transient )
	unsigned char                                      CurrentErrorState;                                		// 0x0224 (0x0001) [0x0000000000002000]              ( CPF_Transient )
	unsigned char                                      RenderThreadErrorState;                           		// 0x0225 (0x0001) [0x0000000000002000]              ( CPF_Transient )
	class UTexture2D*                                  BlackTexture;                                     		// 0x0228 (0x0004) [0x0000000000002000]              ( CPF_Transient )
	struct FScriptDelegate                             __OnVideoFinished__Delegate;                      		// 0x022C (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FScriptDelegate                             __OnVideoError__Delegate;                         		// 0x0238 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
...
// 0x0058 (0x90C0 - 0x9068)
class UPComNetConn : public UTcpipConnection
{
public:
	unsigned char                                      UnknownData00[ 0x58 ];                            		// 0x9068 (0x0058) MISSED OFFSET
