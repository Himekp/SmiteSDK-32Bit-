...
{
	struct FString                                     DD_API_TOKEN;                                     		// 0x0000 (0x000C) [0x0000000000500000]              ( CPF_NeedCtorLink )
	struct FString                                     serverLink;                                       		// 0x000C (0x000C) [0x0000000000500000]              ( CPF_NeedCtorLink )
	struct FString                                     URL;                                              		// 0x0018 (0x000C) [0x0000000000500000]              ( CPF_NeedCtorLink )
	struct FString                                     hostnameTag;                                      		// 0x0024 (0x000C) [0x0000000000500000]              ( CPF_NeedCtorLink )
	struct FString                                     baseSeriesName;                                   		// 0x0030 (0x000C) [0x0000000000500000]              ( CPF_NeedCtorLink )
	int                                                sendIntervalSeconds;                              		// 0x003C (0x0004) [0x0000000000000000]              
	int                                                writeIntervalTicks;                               		// 0x0040 (0x0004) [0x0000000000000000]              
	TArray< struct FString >                           tags;                                             		// 0x0044 (0x000C) [0x0000000000500000]              ( CPF_NeedCtorLink )
};
...
struct FMetricPoint
{
	struct FQWord                                      unixUTCTimestamp;                                 		// 0x0000 (0x0008) [0x0000000000000000]              
...
struct FMetric
{
	...
	TArray< struct FMetricPoint >                      Points;                                           		// 0x0004 (0x000C) [0x0000000000500000]              ( CPF_NeedCtorLink )
};
...
{
	class AActor*                                      Node;                                             		// 0x0000 (0x0004) [0x0000000000000000]              
...
struct FPComPerformanceCaptureStatsPerSkin
{
	...
	struct FString                                     SkinName;                                         		// 0x000C (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FString                                     SkeletalMeshPathName;                             		// 0x0018 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FString                                     SkeletalMeshPathNameHead;                         		// 0x0024 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FString                                     SkeletalMeshPathNameBody;                         		// 0x0030 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FString                                     SkeletalMeshPathNameWeapon;                       		// 0x003C (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	TArray< struct FPComPerformanceCaptureStat >       Stats;                                            		// 0x0048 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
};
...
struct FPComPipViewDesc
{
	...
	class UPostProcessChain*                           PostProcessChain;                                 		// 0x003C (0x0004) [0x0000000000000000]              
	struct FPostProcessSettings                        PostProcessSettings;                              		// 0x0040 (0x0170) [0x0000000000400000]              ( CPF_NeedCtorLink )
	float                                              FOV;                                              		// 0x01B0 (0x0004) [0x0000000000000000]              
	struct FColor                                      ClearColor;                                       		// 0x01B4 (0x0004) [0x0000000000000000]              
	unsigned long                                      bDebugRenderTranslucent : 1;                      		// 0x01B8 (0x0004) [0x0000000000000000] [0x00000001] 
	unsigned long                                      bAlwaysRender : 1;                                		// 0x01B8 (0x0004) [0x0000000000000000] [0x00000002] 
	struct FDouble                                     RequestRenderTime;                                		// 0x01BC (0x0008) [0x0000000000000000]              
	struct FDouble                                     LastRenderedTime;                                 		// 0x01C4 (0x0008) [0x0000000000000000]              
	int                                                NumFramesSinceRender;                             		// 0x01CC (0x0004) [0x0000000000000000]              
};
