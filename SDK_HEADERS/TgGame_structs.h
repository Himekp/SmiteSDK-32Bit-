...
{
	class ATgPawn*                                     m_pawnTarget;                                     		// 0x0000 (0x0004) [0x0000000000000000]              
	unsigned long                                      m_bMinionHit : 1;                                 		// 0x0004 (0x0004) [0x0000000000000000] [0x00000001] 
	unsigned long                                      m_bGodHit : 1;                                    		// 0x0004 (0x0004) [0x0000000000000000] [0x00000002] 
	unsigned long                                      m_bWallHit : 1;                                   		// 0x0004 (0x0004) [0x0000000000000000] [0x00000004] 
	unsigned long                                      m_bUltHit : 1;                                    		// 0x0004 (0x0004) [0x0000000000000000] [0x00000008] 
};
...
struct FKnockUpHitInfo
{
	...
	int                                                m_nKnockUpCount;                                  		// 0x0004 (0x0004) [0x0000000000000000]              
};
...
struct FMulanUltimateHitInfo
{
	...
	TArray< class ATgPawn* >                           m_PawnsHit;                                       		// 0x0004 (0x000C) [0x0000000000500000]              ( CPF_NeedCtorLink )
};
...
struct FCH08_GOO_SPAWNER
{
	...
	class ATgCollisionProxy_CH08*                      collisionProxy;                                   		// 0x0028 (0x0004) [0x0000000000000000]              
};
...
struct FFOG_CONFIG
{
	...
	TArray< class AEmitter* >                          Emitters;                                         		// 0x0010 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
};
...
{
	class ATgPawn*                                     m_pRewardPawn;                                    		// 0x0000 (0x0004) [0x0000000000000000]              
	struct FPEPRewardEntry                             m_eRewardData;                                    		// 0x0004 (0x0014) [0x0000000000000002]              ( CPF_Const )
	float                                              m_fCapturedTime;                                  		// 0x0018 (0x0004) [0x0000000000000000]              
};
...
struct FMicList
{
	TArray< class UMaterialInstanceConstant* >         m_micList;                                        		// 0x0000 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
};

// ScriptStruct TgGame.TgObject.SplineContainer
// 0x001C
...
// ScriptStruct TgGame.TgObject.FullBodyAnimData
// 0x0018
struct FFullBodyAnimData
{
	struct FName                                       m_nmAnimName;                                     		// 0x0000 (0x0008) [0x0000000000000002]              ( CPF_Const )
	float                                              m_fRate;                                          		// 0x0008 (0x0004) [0x0000000000000002]              ( CPF_Const )
	float                                              m_fBlendInTime;                                   		// 0x000C (0x0004) [0x0000000000000002]              ( CPF_Const )
	float                                              m_fBlendOutTime;                                  		// 0x0010 (0x0004) [0x0000000000000002]              ( CPF_Const )
	unsigned long                                      m_bLooping : 1;                                   		// 0x0014 (0x0004) [0x0000000000000002] [0x00000001] ( CPF_Const )
};

// ScriptStruct TgGame.TgObject.UpperBodyAnimData
// 0x0014
struct FUpperBodyAnimData
{
	struct FName                                       m_nmAnimName;                                     		// 0x0000 (0x0008) [0x0000000000000002]              ( CPF_Const )
	float                                              m_fRate;                                          		// 0x0008 (0x0004) [0x0000000000000002]              ( CPF_Const )
	float                                              m_fBlendInTime;                                   		// 0x000C (0x0004) [0x0000000000000002]              ( CPF_Const )
	unsigned long                                      m_bLooping : 1;                                   		// 0x0010 (0x0004) [0x0000000000000002] [0x00000001] ( CPF_Const )
};

// ScriptStruct TgGame.TgObject.ForcedForegroundPscInfo
// 0x0005
struct FForcedForegroundPscInfo
{
	class UParticleSystemComponent*                    m_psc;                                            		// 0x0000 (0x0004) [0x0000000004080008]              ( CPF_ExportObject | CPF_Component | CPF_EditInline )
	unsigned char                                      m_eDepthPriorityGroup;                            		// 0x0004 (0x0001) [0x0000000000000000]              
};
...
struct FScoreKillData
{
	...
	class AController*                                 KillerOverride;                                   		// 0x0040 (0x0004) [0x0000000000000000]              
	class ATgPawn*                                     KillerOverridePawn;                               		// 0x0044 (0x0004) [0x0000000000000000]              
	class ATgRepInfo_Player*                           KillerOverridePRI;                                		// 0x0048 (0x0004) [0x0000000000000000]              
	class ATgRepInfo_TaskForce*                        KillerOverrideTaskForce;                          		// 0x004C (0x0004) [0x0000000000000000]              
	unsigned long                                      KillerOverrideCanScore : 1;                       		// 0x0050 (0x0004) [0x0000000000000000] [0x00000001] 
	class UTgEffectGroup*                              KillingEffectGroup;                               		// 0x0054 (0x0004) [0x0000000000000000]              
	unsigned long                                      bSuicide : 1;                                     		// 0x0058 (0x0004) [0x0000000000000000] [0x00000001] 
	unsigned long                                      bFirstBlood : 1;                                  		// 0x0058 (0x0004) [0x0000000000000000] [0x00000002] 
	TArray< class ATgRepInfo_Player* >                 AssistingPlayers;                                 		// 0x005C (0x000C) [0x0000000000500000]              ( CPF_NeedCtorLink )
};
...
{
	struct FPointer                                    m_dev;                                            		// 0x0000 (0x0004) [0x0000000000001000]              ( CPF_Native )
	int                                                m_nFiringInstance;                                		// 0x0004 (0x0004) [0x0000000000000002]              ( CPF_Const )
	float                                              m_fTimeStamp;                                     		// 0x0008 (0x0004) [0x0000000000000002]              ( CPF_Const )
};
...
struct FIncrementalDamageTracker
{
	...
	class AActor*                                      m_actorHit;                                       		// 0x000C (0x0004) [0x0000000000000002]              ( CPF_Const )
	int                                                m_nHitCount;                                      		// 0x0010 (0x0004) [0x0000000000000000]              
};

// ScriptStruct TgGame.TgObject.IncrementalDamageTrackerList
// 0x0010
struct FIncrementalDamageTrackerList
{
	TArray< struct FIncrementalDamageTracker >         m_trackerList;                                    		// 0x0000 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	float                                              m_fPurgeTime;                                     		// 0x000C (0x0004) [0x0000000000000000]              
};

// ScriptStruct TgGame.TgObject.DeviceInstanceTrackerList
// 0x0010
struct FDeviceInstanceTrackerList
{
	TArray< struct FDeviceInstanceTracker >            m_trackerList;                                    		// 0x0000 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	float                                              m_fPurgeTime;                                     		// 0x000C (0x0004) [0x0000000000000000]              
};
...
struct FOnHealedParams
{
	...
	float                                              fHealAmount;                                      		// 0x0070 (0x0004) [0x0000000000000000]              
	float                                              fHealthChange;                                    		// 0x0074 (0x0004) [0x0000000000000000]              
	int                                                nPropertyId;                                      		// 0x0078 (0x0004) [0x0000000000000000]              
};

// ScriptStruct TgGame.TgObject.OnImmunedEffectParams
// 0x0074
struct FOnImmunedEffectParams
{
	class ATgPawn*                                     pawnAttacker;                                     		// 0x0000 (0x0004) [0x0000000000000000]              
	class ATgDevice*                                   Dev;                                              		// 0x0004 (0x0004) [0x0000000000000000]              
	class UTgEffectGroup*                              eg;                                               		// 0x0008 (0x0004) [0x0000000000000000]              
	struct FImpactInfo                                 Impact;                                           		// 0x000C (0x0064) [0x0000000000080000]              ( CPF_Component )
	int                                                nPropertyId;                                      		// 0x0070 (0x0004) [0x0000000000000000]              
};

// ScriptStruct TgGame.TgObject.OnImmunedDamageParams
// 0x0078
struct FOnImmunedDamageParams
{
	class ATgPawn*                                     pawnAttacker;                                     		// 0x0000 (0x0004) [0x0000000000000000]              
	class ATgDevice*                                   Dev;                                              		// 0x0004 (0x0004) [0x0000000000000000]              
	class UTgEffectGroup*                              eg;                                               		// 0x0008 (0x0004) [0x0000000000000000]              
	struct FImpactInfo                                 Impact;                                           		// 0x000C (0x0064) [0x0000000000080000]              ( CPF_Component )
	float                                              fImmunedDamage;                                   		// 0x0070 (0x0004) [0x0000000000000000]              
...
struct FOnDamagedParams
{
	...
	class UTgEffectGroup*                              eg;                                               		// 0x0008 (0x0004) [0x0000000000000000]              
	struct FImpactInfo                                 Impact;                                           		// 0x000C (0x0064) [0x0000000000080000]              ( CPF_Component )
	float                                              fBuffedDamage;                                    		// 0x0070 (0x0004) [0x0000000000000000]              
	float                                              fMitigatedDamage;                                 		// 0x0074 (0x0004) [0x0000000000000000]              
	float                                              fPreDamageHealth;                                 		// 0x0078 (0x0004) [0x0000000000000000]              
	unsigned long                                      bCritical : 1;                                    		// 0x007C (0x0004) [0x0000000000000000] [0x00000001] 
	int                                                nPropertyId;                                      		// 0x0080 (0x0004) [0x0000000000000000]              
};
...
struct FTG_HUD_INFO
{
	...
	unsigned long                                      bShowTaskForce : 1;                               		// 0x0018 (0x0004) [0x0000000000000000] [0x00000008] 
	unsigned long                                      bIsWinning : 1;                                   		// 0x0018 (0x0004) [0x0000000000000000] [0x00000010] 
	unsigned long                                      bIsTargeted : 1;                                  		// 0x0018 (0x0004) [0x0000000000000000] [0x00000020] 
	...
	int                                                nTaskForce;                                       		// 0x0070 (0x0004) [0x0000000000000000]              
	int                                                nHardCCCategoryId;                                		// 0x0074 (0x0004) [0x0000000000000000]              
	float                                              fHardCCLengthSecs;                                		// 0x0078 (0x0004) [0x0000000000000000]              
	float                                              fHardCCRemainingSecs;                             		// 0x007C (0x0004) [0x0000000000000000]              
	int                                                nImmunityTypeId;                                  		// 0x0080 (0x0004) [0x0000000000000000]              
	struct FTG_HUD_INFO_EFFECTS                        ImportantEffects[ 0x8 ];                          		// 0x0084 (0x00A0) [0x0000000000000000]              
	float                                              fLifeLengthSecs;                                  		// 0x0124 (0x0004) [0x0000000000000000]              
	float                                              fLifeRemainingSecs;                               		// 0x0128 (0x0004) [0x0000000000000000]              
	float                                              fNextLineCheckTime;                               		// 0x012C (0x0004) [0x0000000000000000]              
	unsigned long                                      bLastLineCheckResult : 1;                         		// 0x0130 (0x0004) [0x0000000000000000] [0x00000001] 
	unsigned char                                      eLineCheckState;                                  		// 0x0134 (0x0001) [0x0000000000000000]              
	unsigned char                                      eOffscreenIndicator;                              		// 0x0135 (0x0001) [0x0000000000000000]              
};
...
struct FGAMEMODE_PLAYER_MOD_INFO
{
	...
	TArray< class UTgEffectGroup* >                    EffectGroups;                                     		// 0x0008 (0x000C) [0x0000000000500000]              ( CPF_NeedCtorLink )
};
...
struct FGAMEMODE_PLAYER_MODS
{
	...
	TArray< struct FGAMEMODE_PLAYER_MOD_INFO >         Mods;                                             		// 0x0004 (0x000C) [0x0000000000500000]              ( CPF_NeedCtorLink )
};
...
struct FDeferredNode
{
	...
	unsigned long                                      bExpensiveAction : 1;                             		// 0x0014 (0x0004) [0x0000000000000000] [0x00000001] 
};
...
struct FNavigationQueueEntry
{
	...
	unsigned long                                      bCachedReachability : 1;                          		// 0x0014 (0x0004) [0x0000000000000000] [0x00000002] 
	struct FVector                                     CachedReachabilityLocation;                       		// 0x0018 (0x000C) [0x0000000000000000]              
	float                                              CachedReachabilityTime;                           		// 0x0024 (0x0004) [0x0000000000000000]              
	unsigned long                                      bLookAtTarget : 1;                                		// 0x0028 (0x0004) [0x0000000000000000] [0x00000001] 
	unsigned long                                      bMustHaveLOS : 1;                                 		// 0x0028 (0x0004) [0x0000000000000000] [0x00000002] 
	unsigned long                                      bStopNavOnReachedDestination : 1;                 		// 0x0028 (0x0004) [0x0000000000000000] [0x00000004] 
	float                                              DistanceTolerance;                                		// 0x002C (0x0004) [0x0000000000000000]              
	int                                                NodeToken;                                        		// 0x0030 (0x0004) [0x0000000000000000]              
	int                                                TeleportIndex;                                    		// 0x0034 (0x0004) [0x0000000000000000]              
};
...
{
	struct FString                                     sStoreDeals;                                      		// 0x0000 (0x000C) [0x0000000000444001]              ( CPF_Edit | CPF_Config | CPF_GlobalConfig | CPF_NeedCtorLink )
	struct FString                                     sStoreChests;                                     		// 0x000C (0x000C) [0x0000000000444001]              ( CPF_Edit | CPF_Config | CPF_GlobalConfig | CPF_NeedCtorLink )
	struct FString                                     sStoreGodsSkins;                                  		// 0x0018 (0x000C) [0x0000000000444001]              ( CPF_Edit | CPF_Config | CPF_GlobalConfig | CPF_NeedCtorLink )
};
...
struct FOverlayInfo
{
	...
	struct FOverlayMICList                             OverlayMICInstances[ 0x7 ];                       		// 0x0010 (0x0054) [0x0000000000400000]              ( CPF_NeedCtorLink )
	unsigned char                                      CurrentState;                                     		// 0x0064 (0x0001) [0x0000000000000000]              
};

// ScriptStruct TgGame.TgPawn.ExtraMeshData
// 0x0008
struct FExtraMeshData
{
	class UMeshComponent*                              m_meshComp;                                       		// 0x0000 (0x0004) [0x0000000004080008]              ( CPF_ExportObject | CPF_Component | CPF_EditInline )
	unsigned long                                      m_bCanOverrideMics : 1;                           		// 0x0004 (0x0004) [0x0000000000000000] [0x00000001] 
};
...
struct FSpawnedSkelMeshEntry
{
	...
	class ATgSkeletalMeshActorSpawnable*               SpawnedMesh;                                      		// 0x0004 (0x0004) [0x0000000000000000]              
	class UTgSkeletalMeshComponent*                    SpawnedMeshComp;                                  		// 0x0008 (0x0004) [0x0000000004080008]              ( CPF_ExportObject | CPF_Component | CPF_EditInline )
	class UTgAnimNodeSlot*                             FullBodyNode;                                     		// 0x000C (0x0004) [0x0000000000000000]              
	int                                                nActiveCount;                                     		// 0x0010 (0x0004) [0x0000000000000000]              
};
...
{
	class ATgSkeletalMeshActorSpawnable*               SpawnedMesh;                                      		// 0x0000 (0x0004) [0x0000000000000000]              
	class UAnimNotify*                                 AnimNotifyData;                                   		// 0x0004 (0x0004) [0x0000000000000000]              
};
...
{
	class USoundCue*                                   PlayedCue;                                        		// 0x0000 (0x0004) [0x0000000000000000]              
	float                                              fLastTime;                                        		// 0x0004 (0x0004) [0x0000000000000000]              
	int                                                nGroupNum;                                        		// 0x0008 (0x0004) [0x0000000000000000]              
};

// ScriptStruct TgGame.TgPawn.SpectateCameraRules
// 0x0004
struct FSpectateCameraRules
{
	unsigned long                                      m_bThirdPersonSpectate : 1;                       		// 0x0000 (0x0004) [0x0000000000000000] [0x00000001] 
	unsigned long                                      m_bTopDownSpectate : 1;                           		// 0x0000 (0x0004) [0x0000000000000000] [0x00000002] 
};
...
{
	TArray< struct FMicList >                          m_micOverrides;                                   		// 0x0000 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
};
...
struct FEmoteConfigEntry
{
	...
	unsigned long                                      bWantsSuppressTimeOverride : 1;                   		// 0x0004 (0x0004) [0x0000000000000000] [0x00000004] 
	unsigned long                                      bBlockAnimRestart : 1;                            		// 0x0004 (0x0004) [0x0000000000000000] [0x00000008] 
	unsigned long                                      bLocksMusicTheme : 1;                             		// 0x0004 (0x0004) [0x0000000000000000] [0x00000010] 
	unsigned long                                      bUsesPostProcess : 1;                             		// 0x0004 (0x0004) [0x0000000000000000] [0x00000020] 
	int                                                nLockedBeforeLevel;                               		// 0x0008 (0x0004) [0x0000000000000000]              
	float                                              fSuppressionTimeOverride;                         		// 0x000C (0x0004) [0x0000000000000000]              
};
...
{
	int                                                m_nSupportRecommendedItems[ 0x10 ];               		// 0x0000 (0x0040) [0x0000000000000002]              ( CPF_Const )
	int                                                m_nCarryRecommendedItems[ 0x10 ];                 		// 0x0040 (0x0040) [0x0000000000000002]              ( CPF_Const )
	int                                                m_nMidRecommendedItems[ 0x10 ];                   		// 0x0080 (0x0040) [0x0000000000000002]              ( CPF_Const )
	int                                                m_nSoloRecommendedItems[ 0x10 ];                  		// 0x00C0 (0x0040) [0x0000000000000002]              ( CPF_Const )
	int                                                m_nJungleRecommendedItems[ 0x10 ];                		// 0x0100 (0x0040) [0x0000000000000002]              ( CPF_Const )
	int                                                m_nGenericRecommendedItems[ 0x10 ];               		// 0x0140 (0x0040) [0x0000000000000002]              ( CPF_Const )
	unsigned char                                      m_eCurrentRecommendedRole;                        		// 0x0180 (0x0001) [0x0000000000000002]              ( CPF_Const )
	unsigned long                                      m_bUseRecommendedItems : 1;                       		// 0x0184 (0x0004) [0x0000000000000002] [0x00000001] ( CPF_Const )
	int                                                m_nT3StarterBuildSlot;                            		// 0x0188 (0x0004) [0x0000000000000002]              ( CPF_Const )
	struct FString                                     m_strBotName;                                     		// 0x018C (0x000C) [0x0000000000400002]              ( CPF_Const | CPF_NeedCtorLink )
	int                                                m_nPlayerId;                                      		// 0x0198 (0x0004) [0x0000000000000002]              ( CPF_Const )
	unsigned long                                      m_bLogDebugInfo : 1;                              		// 0x019C (0x0004) [0x0000000000000002] [0x00000001] ( CPF_Const )
};
...
{
	class ATgAIController*                             m_aicPendingRemoveMember;                         		// 0x0000 (0x0004) [0x0000000000000000]              
	unsigned long                                      m_bDied : 1;                                      		// 0x0004 (0x0004) [0x0000000000000000] [0x00000001] 
};
...
{
	TArray< unsigned char >                            eTrackedBehaviors;                                		// 0x0000 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
};
...
{
	class UTgCameraModifier_GameplayCurves*            m_cameraModifierBase;                             		// 0x0000 (0x0004) [0x0000000000000000]              
	class UTgCameraModifier_GameplayCurves*            m_cameraModifierInstance;                         		// 0x0004 (0x0004) [0x0000000000000000]              
	unsigned long                                      m_bActive : 1;                                    		// 0x0008 (0x0004) [0x0000000000000000] [0x00000001] 
	float                                              m_fInterpDurationOverride;                        		// 0x000C (0x0004) [0x0000000000000000]              
};
...
struct FDirectionalProfile
{
	...
	TArray< struct FDirectionTransitionAnimSet >       m_directionTransitionAnimSets;                    		// 0x0004 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
};
...
// ScriptStruct TgGame.TgAnimBlendByFire_Additive.AdditiveAnimSet
// 0x0018
struct FAdditiveAnimSet
{
	struct FName                                       m_nmPreviousFire;                                 		// 0x0000 (0x0008) [0x0000000000000001]              ( CPF_Edit )
	struct FName                                       m_nmNextFire;                                     		// 0x0008 (0x0008) [0x0000000000000001]              ( CPF_Edit )
	struct FName                                       m_nmAdditiveAnimName;                             		// 0x0010 (0x0008) [0x0000000000000001]              ( CPF_Edit )
};
...
{
	struct FName                                       m_nmPreviousFire;                                 		// 0x0000 (0x0008) [0x0000000000000001]              ( CPF_Edit )
	TArray< struct FName >                             m_nmTransitionToFires;                            		// 0x0008 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	struct FName                                       m_nmTransitionAnimName;                           		// 0x0014 (0x0008) [0x0000000000000001]              ( CPF_Edit )
};
...
struct FMirrorImageData
{
	...
	class UTgAnimBlendByG84MirrorImageState*           Node;                                             		// 0x0004 (0x0004) [0x0000000000000000]              
};
...
struct FRacerSoundData
{
	...
	unsigned long                                      ConditionMet : 1;                                 		// 0x0008 (0x0004) [0x0000000000000000] [0x00000001] 
};
...
struct FRacerActionAnimSlotData
{
	...
	TArray< unsigned char >                            InterruptExceptions;                              		// 0x0010 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	float                                              CooldownTime;                                     		// 0x001C (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              LastTriggerTime;                                  		// 0x0020 (0x0004) [0x0000000000002000]              ( CPF_Transient )
};
...
struct FMICScalarParameterSkinIdOverride
{
	...
	TArray< struct FMICScalarParameterKeyFrame >       KeyFrames;                                        		// 0x0014 (0x000C) [0x0000000004400001]              ( CPF_Edit | CPF_NeedCtorLink | CPF_EditInline )
};
...
struct FMICVectorParameterSkinIdOverride
{
	...
	struct FName                                       MICParameterName;                                 		// 0x0008 (0x0008) [0x0000000000000001]              ( CPF_Edit )
	int                                                MaterialIndex;                                    		// 0x0010 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	TArray< struct FMICVectorParameterKeyFrame >       KeyFrames;                                        		// 0x0014 (0x000C) [0x0000000004400001]              ( CPF_Edit | CPF_NeedCtorLink | CPF_EditInline )
};
...
struct FMICVectorSocketSkinIdOverride
{
	...
	TArray< struct FMICVectorSocketKeyFrame >          KeyFrames;                                        		// 0x0028 (0x000C) [0x0000000004400001]              ( CPF_Edit | CPF_NeedCtorLink | CPF_EditInline )
};
...
struct FBoneScaleKeyFrameSkinIdOverride
{
	int                                                nSkinId;                                          		// 0x0000 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	int                                                nSkinLevel;                                       		// 0x0004 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	TArray< struct FName >                             SkelControlNameList;                              		// 0x0008 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	TArray< struct FTimeModifier >                     KeyFrames;                                        		// 0x0014 (0x000C) [0x0000000004400001]              ( CPF_Edit | CPF_NeedCtorLink | CPF_EditInline )
};
...
struct FWithMeshMetaData
{
	...
	TArray< struct FWithMeshKeyFrame >                 KeyFrames;                                        		// 0x0024 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
};
...
{
	struct FPointer                                    m_pAmPetSetup;                                    		// 0x0000 (0x0004) [0x0000000000001002]              ( CPF_Const | CPF_Native )
	float                                              m_fPetSpawnSecs;                                  		// 0x0004 (0x0004) [0x0000000000000002]              ( CPF_Const )
	float                                              m_fVisibilityDelay;                               		// 0x0008 (0x0004) [0x0000000000000002]              ( CPF_Const )
	int                                                m_nBotId;                                         		// 0x000C (0x0004) [0x0000000000000002]              ( CPF_Const )
	int                                                m_nMeshId;                                        		// 0x0010 (0x0004) [0x0000000000000002]              ( CPF_Const )
	unsigned char                                      m_ePetType;                                       		// 0x0014 (0x0001) [0x0000000000000002]              ( CPF_Const )
	unsigned char                                      m_ePetEvolution;                                  		// 0x0015 (0x0001) [0x0000000000000002]              ( CPF_Const )
	unsigned char                                      m_eEqpSlot;                                       		// 0x0016 (0x0001) [0x0000000000000002]              ( CPF_Const )
};
...
{
	class ATgPawn*                                     m_HitGod;                                         		// 0x0000 (0x0004) [0x0000000000000000]              
	int                                                m_nHits;                                          		// 0x0004 (0x0004) [0x0000000000000000]              
};
...
struct FANIM_PAC_INFO
{
	...
	struct FString                                     BoneName;                                         		// 0x0004 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	unsigned long                                      c_bActive : 1;                                    		// 0x0010 (0x0004) [0x0000000000002000] [0x00000001] ( CPF_Transient )
};
...
{
	TArray< struct FName >                             m_nmUseDuringAnims;                               		// 0x0000 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	struct FName                                       m_nmSocketName;                                   		// 0x000C (0x0008) [0x0000000000000001]              ( CPF_Edit )
	struct FName                                       m_nmMeshFullbodyName;                             		// 0x0014 (0x0008) [0x0000000000000001]              ( CPF_Edit )
};
...
{
	int                                                m_nMeshId;                                        		// 0x0000 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	TArray< struct FFullbodyMeshEntry >                m_AnimMap;                                        		// 0x0004 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	unsigned long                                      c_bMeshActive : 1;                                		// 0x0010 (0x0004) [0x0000000000002000] [0x00000001] ( CPF_Transient )
};
...
struct FTgAnimSlotPACMap
{
	int                                                m_nMeshId;                                        		// 0x0000 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	struct FName                                       m_nmBoneName;                                     		// 0x0004 (0x0008) [0x0000000000000001]              ( CPF_Edit )
	TArray< struct FName >                             m_AnimList;                                       		// 0x000C (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	unsigned long                                      c_bPACActive : 1;                                 		// 0x0018 (0x0004) [0x0000000000002000] [0x00000001] ( CPF_Transient )
};
...
struct FPPE_Skin
{
	...
	class UParticleSystem*                             PSTemplateLobby;                                  		// 0x000C (0x0004) [0x0000000000000001]              ( CPF_Edit )
};
...
struct FPSE_Skin
{
	...
	unsigned long                                      bPreventRepeat : 1;                               		// 0x000C (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
	float                                              fCueDuration;                                     		// 0x0010 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	unsigned long                                      bPreventGroupRepeat : 1;                          		// 0x0014 (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
	int                                                nCueGroup;                                        		// 0x0018 (0x0004) [0x0000000000000001]              ( CPF_Edit )
};
...
struct FConditionalAlternativeCueSkinData
{
	...
	class USoundCue*                                   SoundCues[ 0x2 ];                                 		// 0x000C (0x0008) [0x0000000000000001]              ( CPF_Edit )
	unsigned long                                      bPreventRepeat : 1;                               		// 0x0014 (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
	float                                              fCueDuration;                                     		// 0x0018 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	unsigned long                                      bPreventGroupRepeat : 1;                          		// 0x001C (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
	int                                                nCueGroup;                                        		// 0x0020 (0x0004) [0x0000000000000001]              ( CPF_Edit )
};
...
{
	TArray< class ATgBotFactory* >                     TowerFactories;                                   		// 0x0000 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
};
...
struct FArenaTeamSpawns
{
	...
	TArray< class ATgTeamPlayerStart* >                SpawnPoints;                                      		// 0x0004 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
};
...
{
	class ATgBotFactory*                               Factory;                                          		// 0x0000 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	unsigned long                                      bUsesTeamTF : 1;                                  		// 0x0004 (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
	int                                                nTeamOverride;                                    		// 0x0008 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	unsigned long                                      bSetsTF : 1;                                      		// 0x000C (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
	int                                                nFactoryTF;                                       		// 0x0010 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	TArray< int >                                      FactoryModItems;                                  		// 0x0014 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
};
...
struct FArenaFactories
{
	...
	TArray< struct FArenaFactoryInfo >                 Factories;                                        		// 0x0004 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
};
...
struct FPlayerEffects
{
	...
	TArray< int >                                      AppliedTeams;                                     		// 0x0004 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	TArray< int >                                      PlayerModItems;                                   		// 0x0010 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
};
...
struct FArenaEffects
{
	...
	TArray< struct FPlayerEffects >                    EncounterEffects;                                 		// 0x0004 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
};
...
struct FRewardModifiers
{
	...
	TArray< int >                                      TaskForceList;                                    		// 0x0008 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	float                                              fGoldMultStart;                                   		// 0x0014 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              fGoldMultEnd;                                     		// 0x0018 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              fXPMultStart;                                     		// 0x001C (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              fXPMultEnd;                                       		// 0x0020 (0x0004) [0x0000000000000001]              ( CPF_Edit )
};
...
{
	class UMaterialInstanceConstant*                   IndicatorMIC;                                     		// 0x0000 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	unsigned char                                      MinimapType;                                      		// 0x0004 (0x0001) [0x0000000000000001]              ( CPF_Edit )
	TArray< class UMaterialInstanceConstant* >         InWorldMICs;                                      		// 0x0008 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
};
...
{
	TArray< struct FLeashedBotQueueEntry >             SpawnQueue;                                       		// 0x0000 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	float                                              fRespawnDelay;                                    		// 0x000C (0x0004) [0x0000000000000001]              ( CPF_Edit )
	int                                                nVisualOverrideIndex;                             		// 0x0010 (0x0004) [0x0000000000000001]              ( CPF_Edit )
...
struct FQueueProfile
{
	...
	TArray< struct FLeashedBotQueue >                  ProfileQueues;                                    		// 0x0004 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	float                                              fUseAfterTime;                                    		// 0x0010 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	TArray< int >                                      nCustomOrder;                                     		// 0x0014 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	int                                                nCustomOrderIndex;                                		// 0x0020 (0x0004) [0x0000000000000000]              
	int                                                nStartingQueue;                                   		// 0x0024 (0x0004) [0x0000000000000001]              ( CPF_Edit )
};
...
{
	TArray< struct FName >                             Bots;                                             		// 0x0000 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
};
...
{
	float                                              fUseAfterTime;                                    		// 0x0000 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	TArray< struct FQueueEntryData >                   SpawnEntries;                                     		// 0x0004 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
};
...
{
	class UParticleSystemComponent*                    m_psc;                                            		// 0x0000 (0x0004) [0x0000000004080008]              ( CPF_ExportObject | CPF_Component | CPF_EditInline )
	struct FVector                                     m_vTranslation;                                   		// 0x0004 (0x000C) [0x0000000000000000]              
	struct FRotator                                    m_rRotation;                                      		// 0x0010 (0x000C) [0x0000000000000000]              
	unsigned long                                      m_bAbsoluteTranslation : 1;                       		// 0x001C (0x0004) [0x0000000000000000] [0x00000001] 
	unsigned long                                      m_bAbsoluteRotation : 1;                          		// 0x001C (0x0004) [0x0000000000000000] [0x00000002] 
};
...
struct FTgTimerData
{
	...
	struct FTGT_REG_LINK                               CallbackRegistry;                                 		// 0x0018 (0x000C) [0x0000000000000000]              
};
...
struct FRollingLineAttack
{
	...
	TArray< class AActor* >                            HitActors;                                        		// 0x002C (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
};
...
struct FProxyFxInfo
{
	...
	class ATgPawn*                                     Target;                                           		// 0x0004 (0x0004) [0x0000000000000000]              
};
...
{
	class ATgPawn*                                     trackedPawn;                                      		// 0x0000 (0x0004) [0x0000000000000000]              
	struct FVector                                     vPreviousLocation;                                		// 0x0004 (0x000C) [0x0000000000000000]              
	unsigned long                                      bDeleteAfterUpdate : 1;                           		// 0x0010 (0x0004) [0x0000000000000000] [0x00000001] 
};
...
{
	class AActor*                                      m_Actor;                                          		// 0x0000 (0x0004) [0x0000000000000000]              
	class UPrimitiveComponent*                         m_HitComp;                                        		// 0x0004 (0x0004) [0x0000000004080008]              ( CPF_ExportObject | CPF_Component | CPF_EditInline )
};
...
struct FYemojaOverlappingActor
{
	...
	class ATgCollisionProxy_Yemoja_A04*                m_WallProxy;                                      		// 0x0010 (0x0004) [0x0000000000000000]              
};

// ScriptStruct TgGame.TgCritProbability.CritProbabilityPair
// 0x0008
struct FCritProbabilityPair
{
	float                                              m_fP;                                             		// 0x0000 (0x0004) [0x0000000000000000]              
	float                                              m_fC;                                             		// 0x0004 (0x0004) [0x0000000000000000]              
};
...
struct FSpectatorBookmark
{
	...
	struct FTPOV                                       POV;                                              		// 0x0008 (0x0024) [0x0000000000000000]              
};
...
// ScriptStruct TgGame.TgDeploy_Atlas_A04.AtlasUltFx
// 0x000C
struct FAtlasUltFx
{
	int                                                m_nFxId;                                          		// 0x0000 (0x0004) [0x0000000000000002]              ( CPF_Const )
	unsigned long                                      m_bPlaysTransitions : 1;                          		// 0x0004 (0x0004) [0x0000000000000002] [0x00000001] ( CPF_Const )
	class UTgSpecialFx*                                m_fx;                                             		// 0x0008 (0x0004) [0x0000000000000000]              
};

// ScriptStruct TgGame.TgDeploy_Atlas_A04.AtlasUltPscTransition
// 0x0010
struct FAtlasUltPscTransition
{
	struct FName                                       m_nmParameter;                                    		// 0x0000 (0x0008) [0x0000000000000002]              ( CPF_Const )
	float                                              m_fTarget;                                        		// 0x0008 (0x0004) [0x0000000000000002]              ( CPF_Const )
	float                                              m_fDuration;                                      		// 0x000C (0x0004) [0x0000000000000002]              ( CPF_Const )
};
...
{
	class ATgPawn*                                     m_pawnTracked;                                    		// 0x0000 (0x0004) [0x0000000000000002]              ( CPF_Const )
	unsigned char                                      m_eBuffType;                                      		// 0x0004 (0x0001) [0x0000000000000000]              
};
...
{
	class ATgPawn*                                     m_pawnTracked;                                    		// 0x0000 (0x0004) [0x0000000000000002]              ( CPF_Const )
	unsigned long                                      m_bValidSpeedBuff : 1;                            		// 0x0004 (0x0004) [0x0000000000000000] [0x00000001] 
};
...
{
	class ATgPawn*                                     m_pawnTouched;                                    		// 0x0000 (0x0004) [0x0000000000000000]              
	unsigned char                                      m_eTouchLocation;                                 		// 0x0004 (0x0001) [0x0000000000000000]              
};
...
{
	class ATgPawn*                                     m_Pawn;                                           		// 0x0000 (0x0004) [0x0000000000000000]              
	struct FVector                                     m_vLastValidOctogonLoc;                           		// 0x0004 (0x000C) [0x0000000000000000]              
	unsigned long                                      m_bIsTouching : 1;                                		// 0x0010 (0x0004) [0x0000000000000000] [0x00000001] 
};
...
{
	class ATgPawn*                                     m_Pawn;                                           		// 0x0000 (0x0004) [0x0000000000000000]              
	unsigned long                                      m_bHasTicked : 1;                                 		// 0x0004 (0x0004) [0x0000000000000000] [0x00000001] 
};
...
struct FPersephoneA02DeployableData
{
	...
	class ATgDevice*                                   m_SubDevice;                                      		// 0x0004 (0x0004) [0x0000000000000000]              
};
...
struct FPersephoneA04ClientDeployableData
{
	...
	class UTgStaticMeshComponent*                      TetherMeshComponent;                              		// 0x0004 (0x0004) [0x0000000004080008]              ( CPF_ExportObject | CPF_Component | CPF_EditInline )
	struct FVector                                     vLastValidLocation;                               		// 0x0008 (0x000C) [0x0000000000000000]              
};
...
struct FPersephoneA04DeployableData
{
	...
	class ATgDeploy_Persephone_A04_Bounds*             BoundWallComponent;                               		// 0x0008 (0x0004) [0x0000000000000000]              
	int                                                nHitApplied;                                      		// 0x000C (0x0004) [0x0000000000000000]              
	int                                                nIsImmune;                                        		// 0x0010 (0x0004) [0x0000000000000000]              
	int                                                nIsOutOfRange;                                    		// 0x0014 (0x0004) [0x0000000000000000]              
	unsigned long                                      bHasSlowDebuff : 1;                               		// 0x0018 (0x0004) [0x0000000000000000] [0x00000001] 
};
...
{
	class ATgPawn_Racer*                               racerTarget;                                      		// 0x0000 (0x0004) [0x0000000000000000]              
	int                                                nPlacesAhead;                                     		// 0x0004 (0x0004) [0x0000000000000000]              
};
...
// ScriptStruct TgGame.TgVisionRestrictionVolume.VisionRestrictionData
// 0x0008
struct FVisionRestrictionData
{
	class ATgPawn*                                     m_pawnTracked;                                    		// 0x0000 (0x0004) [0x0000000000000000]              
	unsigned long                                      m_bStealthed : 1;                                 		// 0x0004 (0x0004) [0x0000000000000000] [0x00000001] 
};
...
{
	class UTgEffectGroup*                              m_EffectGroup;                                    		// 0x0000 (0x0004) [0x0000000000000000]              
};
...
{
	class ATgPawn*                                     m_Pawn;                                           		// 0x0000 (0x0004) [0x0000000000000000]              
	unsigned long                                      m_bLaunchLocked : 1;                              		// 0x0004 (0x0004) [0x0000000000000000] [0x00000001] 
	unsigned long                                      m_bHasLaunched : 1;                               		// 0x0004 (0x0004) [0x0000000000000000] [0x00000002] 
};
...
struct FCamazotzTouchData
{
	...
	float                                              m_fTimeSinceLastDrink;                            		// 0x0004 (0x0004) [0x0000000000000000]              
};
...
{
	class ATgPawn*                                     CarrierPawn;                                      		// 0x0000 (0x0004) [0x0000000000000000]              
	class ATgDevice*                                   OriginalInhandDevice;                             		// 0x0004 (0x0004) [0x0000000000000000]              
	class ATgDevice*                                   OriginalRelic01Device;                            		// 0x0008 (0x0004) [0x0000000000000000]              
	class ATgDevice*                                   OriginalRelic02Device;                            		// 0x000C (0x0004) [0x0000000000000000]              
	class ATgDevice*                                   ChargeDevice;                                     		// 0x0010 (0x0004) [0x0000000000000000]              
	class ATgDevice*                                   MeleeDevice;                                      		// 0x0014 (0x0004) [0x0000000000000000]              
	class ATgDevice*                                   ThrowDevice;                                      		// 0x0018 (0x0004) [0x0000000000000000]              
};
...
{
	class AActor*                                      Target;                                           		// 0x0000 (0x0004) [0x0000000000000000]              
	float                                              TimeToReDamage;                                   		// 0x0004 (0x0004) [0x0000000000000000]              
	unsigned long                                      TouchingProxy : 1;                                		// 0x0008 (0x0004) [0x0000000000000000] [0x00000001] 
};
...
{
	class UMeshComponent*                              c_Mesh[ 0x2 ];                                    		// 0x0000 (0x0008) [0x000000000408000A]              ( CPF_Const | CPF_ExportObject | CPF_Component | CPF_EditInline )
	class UTgSpecialFx*                                c_BarrierFX;                                      		// 0x0008 (0x0004) [0x0000000000000002]              ( CPF_Const )
	class UTgSpecialFx*                                c_BarrierBreakFX;                                 		// 0x000C (0x0004) [0x0000000000000002]              ( CPF_Const )
	struct FVector                                     m_vSectionStart;                                  		// 0x0010 (0x000C) [0x0000000000000002]              ( CPF_Const )
	int                                                m_nMeshId[ 0x2 ];                                 		// 0x001C (0x0008) [0x0000000000000002]              ( CPF_Const )
	int                                                m_nBarrierFXId;                                   		// 0x0024 (0x0004) [0x0000000000000002]              ( CPF_Const )
	int                                                m_nBarrierBreakFXId;                              		// 0x0028 (0x0004) [0x0000000000000002]              ( CPF_Const )
	unsigned long                                      m_bIsVisible : 1;                                 		// 0x002C (0x0004) [0x0000000000000002] [0x00000001] ( CPF_Const )
};
...
{
	struct FInterpCurveVector                          cvSpline;                                         		// 0x0000 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FInterpCurveFloat                           cfRate;                                           		// 0x0010 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	TArray< class ATgSplineLoftActorSpawnable* >       ArcMeshes;                                        		// 0x0020 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	float                                              fCurPerc;                                         		// 0x002C (0x0004) [0x0000000000000000]              
	float                                              fCurInVal;                                        		// 0x0030 (0x0004) [0x0000000000000000]              
	struct FVector                                     vRight;                                           		// 0x0034 (0x000C) [0x0000000000000000]              
	class ATgSkeletalMeshActorSpawnable*               masHeadMesh;                                      		// 0x0040 (0x0004) [0x0000000000000000]              
};
...
{
	class ATgPawn*                                     m_Player;                                         		// 0x0000 (0x0004) [0x0000000000000000]              
	int                                                m_nTimesHit;                                      		// 0x0004 (0x0004) [0x0000000000000000]              
};
...
{
	TArray< struct FRacerLootData >                    Data;                                             		// 0x0000 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	int                                                TotalWeight;                                      		// 0x000C (0x0004) [0x0000000000000000]              
};
...
{
	class ATgDeployable_Tsukuyomi_A03*                 m_a03Deploy;                                      		// 0x0000 (0x0004) [0x0000000000000002]              ( CPF_Const )
	class ATgPawn*                                     m_trackedPawn;                                    		// 0x0004 (0x0004) [0x0000000000000002]              ( CPF_Const )
	struct FVector                                     s_vPreviousLocation;                              		// 0x0008 (0x000C) [0x0000000000000000]              
	float                                              s_fDistanceMoved;                                 		// 0x0014 (0x0004) [0x0000000000000000]              
};
...
{
	class ATgPawn_Depthzy*                             m_depthzy;                                        		// 0x0000 (0x0004) [0x0000000000000000]              
	class UTgMapTracker_Depthzy_IState*                m_mapTracker;                                     		// 0x0004 (0x0004) [0x0000000000000000]              
	class UTgMeshPool_Depthzy_IState*                  m_meshPool;                                       		// 0x0008 (0x0004) [0x0000000000000000]              
};
...
{
	class AActor*                                      s_PreviousArcTarget;                              		// 0x0000 (0x0004) [0x0000000000000000]              
	TArray< class AActor* >                            s_PreviousTargets;                                		// 0x0004 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	class UTgDeviceFire_ArcingBeam*                    s_ArcFiremode;                                    		// 0x0010 (0x0004) [0x0000000000000000]              
	int                                                s_nFiringInstance;                                		// 0x0014 (0x0004) [0x0000000000000000]              
	int                                                s_nJumpsRemaining;                                		// 0x0018 (0x0004) [0x0000000000000000]              
	float                                              s_fPersistPulseTime;                              		// 0x001C (0x0004) [0x0000000000000000]              
	float                                              s_fArcRange;                                      		// 0x0020 (0x0004) [0x0000000000000000]              
	float                                              s_fTriggerTime;                                   		// 0x0024 (0x0004) [0x0000000000000000]              
};

// ScriptStruct TgGame.TgPawn_Atlas.AtlasChargeExplosionFxData
// 0x001C
struct FAtlasChargeExplosionFxData
{
	struct FVector                                     m_vSpawnLocation;                                 		// 0x0000 (0x000C) [0x0000000000000000]              
	struct FVector                                     m_vSpawnRotation;                                 		// 0x000C (0x000C) [0x0000000000000000]              
	int                                                m_nFlashCount;                                    		// 0x0018 (0x0004) [0x0000000000000000]              
};
...
{
	class UTgSkeletalMeshComponent*                    m_Mesh;                                           		// 0x0000 (0x0004) [0x0000000004080008]              ( CPF_ExportObject | CPF_Component | CPF_EditInline )
	class UTgAnimNodeSlot*                             m_FullBodyNode;                                   		// 0x0004 (0x0004) [0x0000000000000000]              
	unsigned char                                      m_eSphinxPosition;                                		// 0x0008 (0x0001) [0x0000000000000000]              
};
...
{
	class AActor*                                      HitActor;                                         		// 0x0000 (0x0004) [0x0000000000000000]              
	int                                                bleedStacks;                                      		// 0x0004 (0x0004) [0x0000000000000000]              
};
...
// ScriptStruct TgGame.TgDevice_ChaoticBeads.BeadsInstigatorTracker
// 0x0008
struct FBeadsInstigatorTracker
{
	class ATgPawn*                                     m_Instigator;                                     		// 0x0000 (0x0004) [0x0000000000000000]              
...
// ScriptStruct TgGame.TgDevice_Cliodhna_A04_Sub.DeployableHitTracker
// 0x000C
struct FDeployableHitTracker
{
	class AActor*                                      m_actorHit;                                       		// 0x0000 (0x0004) [0x0000000000000000]              
	unsigned char                                      m_nDeployableFiringInstance;                      		// 0x0004 (0x0001) [0x0000000000000000]              
	int                                                m_nHitCount;                                      		// 0x0008 (0x0004) [0x0000000000000000]              
};
...
struct FCuChulainnVentSteamHits
{
	...
	int                                                nNumHits;                                         		// 0x0004 (0x0004) [0x0000000000000000]              
};
...
{
	class ATgPawn*                                     m_pawnTarget;                                     		// 0x0000 (0x0004) [0x0000000000000000]              
	float                                              m_fTimeTillTormentApplies;                        		// 0x0004 (0x0004) [0x0000000000000000]              
};
...
{
	TArray< struct FDialogueLineInfo >                 m_Lines;                                          		// 0x0000 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	TArray< int >                                      m_RequiredSpeakerIds;                             		// 0x000C (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FName                                       m_nmDamageTypeClass;                              		// 0x0018 (0x0008) [0x0000000000000002]              ( CPF_Const )
	float                                              m_fPctChanceTrigger;                              		// 0x0020 (0x0004) [0x0000000000000002]              ( CPF_Const )
	float                                              m_fMinInGameTriggerTime;                          		// 0x0024 (0x0004) [0x0000000000000002]              ( CPF_Const )
	float                                              m_fMaxInGameTriggerTime;                          		// 0x0028 (0x0004) [0x0000000000000002]              ( CPF_Const )
	float                                              m_fTotalLifeTime;                                 		// 0x002C (0x0004) [0x0000000000000002]              ( CPF_Const )
	unsigned long                                      m_bHasBeenTriggeredOnce : 1;                      		// 0x0030 (0x0004) [0x0000000000000000] [0x00000001] 
};
...
{
	TArray< struct FWizardEqpPair >                    m_pairs;                                          		// 0x0000 (0x000C) [0x0000000000400002]              ( CPF_Const | CPF_NeedCtorLink )
};
...
struct FWizardA03Fx
{
	class UTgSpecialFx*                                c_EnterFx;                                        		// 0x0000 (0x0004) [0x0000000000000002]              ( CPF_Const )
	class UTgSpecialFx*                                c_ExitFx;                                         		// 0x0004 (0x0004) [0x0000000000000002]              ( CPF_Const )
};
...
{
	class AActor*                                      EnemyTarget;                                      		// 0x0000 (0x0004) [0x0000000000000000]              
	unsigned long                                      InSlice : 1;                                      		// 0x0004 (0x0004) [0x0000000000000000] [0x00000001] 
};
...
{
	class ATgPawn*                                     m_pawnTarget;                                     		// 0x0000 (0x0004) [0x0000000000000002]              ( CPF_Const )
	unsigned char                                      m_byPSVStateFlags;                                		// 0x0004 (0x0001) [0x0000000000000000]              
};
...
{
	class AActor*                                      Other;                                            		// 0x0000 (0x0004) [0x0000000000000000]              
	TArray< class ATgDeployable* >                     Deps;                                             		// 0x0004 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
};
...
{
	class AActor*                                      m_aHitTarget;                                     		// 0x0000 (0x0004) [0x0000000000000000]              
	unsigned char                                      m_nSinusoidHitCount;                              		// 0x0004 (0x0001) [0x0000000000000000]              
	unsigned char                                      m_nMiddleHitCount;                                		// 0x0005 (0x0001) [0x0000000000000000]              
};
...
{
	TArray< struct FDeathGateTargetHits >              m_targetHits;                                     		// 0x0000 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	int                                                m_nFiringInstance;                                		// 0x000C (0x0004) [0x0000000000000000]              
};
...
{
	class AActor*                                      HitActor;                                         		// 0x0000 (0x0004) [0x0000000000000000]              
	int                                                nHitCounter;                                      		// 0x0004 (0x0004) [0x0000000000000000]              
};
...
{
	class AActor*                                      m_TouchedActor;                                   		// 0x0000 (0x0004) [0x0000000000000000]              
...
// ScriptStruct TgGame.TgPawn_Tiamat.TiamatAmmoStage_Mirror
// 0x0008
struct FTiamatAmmoStage_Mirror
{
	int                                                m_nAmmoCount;                                     		// 0x0000 (0x0004) [0x0000000000000000]              
	float                                              m_fTimeFinished;                                  		// 0x0004 (0x0004) [0x0000000000000000]              
};
...
{
	struct FImpactInfo                                 ImpactInfo;                                       		// 0x0000 (0x0064) [0x0000000000080000]              ( CPF_Component )
	int                                                NumConesHit;                                      		// 0x0064 (0x0004) [0x0000000000000000]              
};
...
{
	class AActor*                                      m_aDamageInstigator;                              		// 0x0000 (0x0004) [0x0000000000000000]              
	class UTgDeviceFire*                               m_FireMode;                                       		// 0x0004 (0x0004) [0x0000000000000000]              
	struct FVector                                     m_vCurveStart;                                    		// 0x0008 (0x000C) [0x0000000000000000]              
	struct FVector                                     m_vStart;                                         		// 0x0014 (0x000C) [0x0000000000000000]              
	struct FVector                                     m_vEnd;                                           		// 0x0020 (0x000C) [0x0000000000000000]              
	float                                              m_fExtentRadius;                                  		// 0x002C (0x0004) [0x0000000000000000]              
	unsigned long                                      m_bPredicting : 1;                                		// 0x0030 (0x0004) [0x0000000000000000] [0x00000001] 
};
...
// ScriptStruct TgGame.TgDeviceForm_Cliodhna_Psv.MicPawnListMap
// 0x0014
struct FMicPawnListMap
{
	class ATgPawn*                                     m_pawnTarget;                                     		// 0x0000 (0x0004) [0x0000000000000000]              
	class UMeshComponent*                              m_meshExtra;                                      		// 0x0004 (0x0004) [0x0000000004080008]              ( CPF_ExportObject | CPF_Component | CPF_EditInline )
	TArray< class UMaterialInstanceConstant* >         m_micList;                                        		// 0x0008 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
};
...
struct FWizardB02Targeter
{
	...
	class ATgSkeletalMeshActor*                        m_MeshIndicator;                                  		// 0x0004 (0x0004) [0x0000000000000000]              
	class UTgSpecialFx*                                m_TargetingFx;                                    		// 0x0008 (0x0004) [0x0000000000000000]              
};
...
{
	class UTgSpecialFx*                                m_fx;                                             		// 0x0000 (0x0004) [0x0000000000000000]              
	float                                              m_fScale;                                         		// 0x0004 (0x0004) [0x0000000000000000]              
};
...
struct FDVTSTouchedPawn
{
	...
	class ATgPawn*                                     TouchedPawn;                                      		// 0x0004 (0x0004) [0x0000000000000000]              
	float                                              fCurrentTimer;                                    		// 0x0008 (0x0004) [0x0000000000000000]              
	int                                                nNumStacks;                                       		// 0x000C (0x0004) [0x0000000000000000]              
};
...
struct FMicFxInfo
{
	class UMaterialInstanceConstant*                   m_micFx;                                          		// 0x0000 (0x0004) [0x0000000000000000]              
	unsigned long                                      c_bApplied : 1;                                   		// 0x0004 (0x0004) [0x0000000000000000] [0x00000001] 
};
...
struct FEffectMeshInfo
{
	...
	struct FName                                       DisplayGroup;                                     		// 0x0004 (0x0008) [0x0000000000000000]              
	...
	int                                                nMeshId;                                          		// 0x0030 (0x0004) [0x0000000000000000]              
	int                                                nSkinId;                                          		// 0x0034 (0x0004) [0x0000000000000000]              
	unsigned long                                      AbsoluteTranslation : 1;                          		// 0x0038 (0x0004) [0x0000000000000000] [0x00000001] 
	unsigned long                                      AbsoluteRotation : 1;                             		// 0x0038 (0x0004) [0x0000000000000000] [0x00000002] 
	unsigned long                                      AbsoluteScale : 1;                                		// 0x0038 (0x0004) [0x0000000000000000] [0x00000004] 
	unsigned long                                      bWillSelfDestruct : 1;                            		// 0x0038 (0x0004) [0x0000000000000000] [0x00000008] 
	unsigned long                                      bUsesParentAnimComponent : 1;                     		// 0x0038 (0x0004) [0x0000000000000000] [0x00000010] 
	unsigned long                                      bLoopAnim : 1;                                    		// 0x0038 (0x0004) [0x0000000000000000] [0x00000020] 
};
...
{
	class UTgDeviceFire*                               m_DeviceMode;                                     		// 0x0000 (0x0004) [0x0000000000000000]              
	int                                                m_nFiringInstance;                                		// 0x0004 (0x0004) [0x0000000000000000]              
};
...
struct FFxPool
{
	TArray< class UTgSpecialFx* >                      m_fxList;                                         		// 0x0000 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	int                                                m_nTotalFxCount;                                  		// 0x000C (0x0004) [0x0000000000000000]              
};
...
struct FPauseVoteData
{
	...
	TArray< int >                                      PauseVotes;                                       		// 0x0004 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	int                                                nPauseTotal;                                      		// 0x0010 (0x0004) [0x0000000000000000]              
	int                                                nPauseNeeded;                                     		// 0x0014 (0x0004) [0x0000000000000000]              
	int                                                nPausesRemaining;                                 		// 0x0018 (0x0004) [0x0000000000000000]              
	unsigned long                                      bPausePending : 1;                                		// 0x001C (0x0004) [0x0000000000000000] [0x00000001] 
	unsigned long                                      bDisconnectPauseLimitOverride : 1;                		// 0x001C (0x0004) [0x0000000000000000] [0x00000002] 
};
...
{
	class AController*                                 ControllerEntry;                                  		// 0x0000 (0x0004) [0x0000000000000000]              
	float                                              fCurrentXp;                                       		// 0x0004 (0x0004) [0x0000000000000000]              
};
...
{
	TArray< struct FXPTrackingEntry >                  XPList;                                           		// 0x0000 (0x000C) [0x0000000000500000]              ( CPF_NeedCtorLink )
	int                                                nTaskForce;                                       		// 0x000C (0x0004) [0x0000000000000000]              
};
...
struct FCH06_ROUND_STATS
{
	...
	TArray< int >                                      PlayerList;                                       		// 0x0044 (0x000C) [0x0000000000500000]              ( CPF_NeedCtorLink )
	TArray< int >                                      DeathCounts;                                      		// 0x0050 (0x000C) [0x0000000000500000]              ( CPF_NeedCtorLink )
	float                                              fRoundScore;                                      		// 0x005C (0x0004) [0x0000000000000000]              
};
...
{
	TArray< int >                                      nRoundTaskForces;                                 		// 0x0000 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	TArray< int >                                      nTeamRanks;                                       		// 0x000C (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	int                                                nEncounter;                                       		// 0x0018 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	int                                                nArenaId;                                         		// 0x001C (0x0004) [0x0000000000000001]              ( CPF_Edit )
	unsigned char                                      eTFSelectionStrategy;                             		// 0x0020 (0x0001) [0x0000000000000001]              ( CPF_Edit )
};
...
{
	TArray< struct FArenaRoundConfig >                 m_Matches;                                        		// 0x0000 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	int                                                nStoreTime;                                       		// 0x000C (0x0004) [0x0000000000000001]              ( CPF_Edit )
	int                                                nSetupTime;                                       		// 0x0010 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	int                                                nRoundTime;                                       		// 0x0014 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	int                                                nPostRoundTime;                                   		// 0x0018 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	int                                                nGoldGift;                                        		// 0x001C (0x0004) [0x0000000000000001]              ( CPF_Edit )
	int                                                nPlayerLevel;                                     		// 0x0020 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	int                                                nPlayerXP;                                        		// 0x0024 (0x0004) [0x0000000000000001]              ( CPF_Edit )
};
...
// ScriptStruct TgGame.TgGameConfig_MultiRounds.CustomChanceItem
// 0x0008
...
struct FBotShopBag
{
	TArray< struct FBotShopUnit >                      m_UnitList;                                       		// 0x0000 (0x000C) [0x0000000000400003]              ( CPF_Edit | CPF_Const | CPF_NeedCtorLink )
	TArray< struct FBotShopBag >                       m_BagList;                                        		// 0x000C (0x000C) [0x0000000000400003]              ( CPF_Edit | CPF_Const | CPF_NeedCtorLink )
	float                                              m_fWeight;                                        		// 0x0018 (0x0004) [0x0000000000000003]              ( CPF_Edit | CPF_Const )
	float                                              m_fSellBackPct;                                   		// 0x001C (0x0004) [0x0000000000000003]              ( CPF_Edit | CPF_Const )
	float                                              m_fUnitWeightSum;                                 		// 0x0020 (0x0004) [0x0000000000000002]              ( CPF_Const )
	float                                              m_fBagWeightSum;                                  		// 0x0024 (0x0004) [0x0000000000000002]              ( CPF_Const )
};
...
{
	TArray< float >                                    s_fRoundVals;                                     		// 0x0000 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
};
...
{
	class ATgPawn_Heimdallr*                           m_PawnRep;                                        		// 0x0000 (0x0004) [0x0000000000000000]              
	TArray< struct FHeimA04Meshes >                    m_UltVisuals;                                     		// 0x0004 (0x000C) [0x0000000000580000]              ( CPF_Component | CPF_NeedCtorLink )
};
...
{
	TArray< int >                                      m_nItems;                                         		// 0x0000 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
};
...
struct FThorLightningTarget
{
	...
	int                                                m_nLightningInstance;                             		// 0x0004 (0x0004) [0x0000000000000000]              
};
...
{
	class ATgPawn*                                     TargetPawn;                                       		// 0x0000 (0x0004) [0x0000000000000000]              
	unsigned long                                      bHasBeenHit : 1;                                  		// 0x0004 (0x0004) [0x0000000000000000] [0x00000001] 
};
...
{
	class AActor*                                      m_TrackedActor;                                   		// 0x0000 (0x0004) [0x0000000000000000]              
	unsigned long                                      m_bIsBleeding : 1;                                		// 0x0004 (0x0004) [0x0000000000000000] [0x00000001] 
	unsigned long                                      m_bSpawnFlag : 1;                                 		// 0x0004 (0x0004) [0x0000000000000000] [0x00000002] 
	unsigned char                                      m_eTravelingState;                                		// 0x0008 (0x0001) [0x0000000000000000]              
	TArray< class ATgCollisionProxy_Bastet_PSV* >      m_TrailProxies;                                   		// 0x000C (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
};
...
struct FDTFireInstanceData
{
	...
	TArray< int >                                      FiringInstances;                                  		// 0x0004 (0x000C) [0x0000000000500000]              ( CPF_NeedCtorLink )
};
...
{
	int                                                DeviceID;                                         		// 0x0000 (0x0004) [0x0000000000000000]              
	TArray< struct FDOHFireInstanceCount >             FireInstanceCounts;                               		// 0x0004 (0x000C) [0x0000000000500000]              ( CPF_NeedCtorLink )
};
...
{
	class AActor*                                      m_actorTracked;                                   		// 0x0000 (0x0004) [0x0000000000000002]              ( CPF_Const )
	float                                              m_fMuliHitDamagePercent;                          		// 0x0004 (0x0004) [0x0000000000000000]              
	int                                                m_nTrackedFiringInstance;                         		// 0x0008 (0x0004) [0x0000000000000000]              
	int                                                m_nRollingHits;                                   		// 0x000C (0x0004) [0x0000000000000000]              
	int                                                m_nBombHits;                                      		// 0x0010 (0x0004) [0x0000000000000000]              
};
...
struct FDEV_INST_INFO
{
	...
	TArray< int >                                      TrackedInstances;                                 		// 0x0004 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
};
...
// ScriptStruct TgGame.TgInventoryObject_Listen_Effect_EmblemOfIncreasingPeril.EmblemOfIncreasingPerilTracker
// 0x0010
struct FEmblemOfIncreasingPerilTracker
{
	class ATgPawn*                                     m_pawnTarget;                                     		// 0x0000 (0x0004) [0x0000000000000000]              
	float                                              m_fMaxHealth;                                     		// 0x0004 (0x0004) [0x0000000000000000]              
	float                                              m_fDamageThreshold;                               		// 0x0008 (0x0004) [0x0000000000000000]              
	float                                              m_fTotalDamageDealt;                              		// 0x000C (0x0004) [0x0000000000000000]              
};
...
{
	class ATgPawn*                                     m_HitPawn;                                        		// 0x0000 (0x0004) [0x0000000000000000]              
	int                                                m_nFiringInstance;                                		// 0x0004 (0x0004) [0x0000000000000000]              
};
...
{
	class AActor*                                      m_trackedTarget;                                  		// 0x0000 (0x0004) [0x0000000000000002]              ( CPF_Const )
	float                                              m_fTimeSinceLastHit;                              		// 0x0004 (0x0004) [0x0000000000000000]              
};
...
{
	class AActor*                                      m_actorPowerScaled;                               		// 0x0000 (0x0004) [0x0000000000000000]              
	int                                                m_nFiringInstance;                                		// 0x0004 (0x0004) [0x0000000000000000]              
};
...
{
	class ATgPawn*                                     m_HitPawn;                                        		// 0x0000 (0x0004) [0x0000000000000000]              
	int                                                m_nStacks;                                        		// 0x0004 (0x0004) [0x0000000000000000]              
};
...
{
	class ATgPawn*                                     PrevHitTarget;                                    		// 0x0000 (0x0004) [0x0000000000000000]              
	float                                              fPrevHitTime;                                     		// 0x0004 (0x0004) [0x0000000000000000]              
	int                                                nTargetHitCount;                                  		// 0x0008 (0x0004) [0x0000000000000000]              
};
...
{
	class ATgDevice*                                   m_Device;                                         		// 0x0000 (0x0004) [0x0000000000000000]              
	int                                                m_nFiringInstance;                                		// 0x0004 (0x0004) [0x0000000000000000]              
};
...
{
	int                                                nDevId;                                           		// 0x0000 (0x0004) [0x0000000000000000]              
	TArray< int >                                      nFiringInstance;                                  		// 0x0004 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
};
...
struct FLobbyFocusData
{
	...
	class ATgSkeletalMeshActor_Lobby*                  ViewTarget;                                       		// 0x0018 (0x0004) [0x0000000000000001]              ( CPF_Edit )
};

// ScriptStruct TgGame.TgMapTracker_Cliodhna_Psv.CliodhnaPsvWallSegment
// 0x000C
struct FCliodhnaPsvWallSegment
{
	int                                                m_nFirstAdjIdx;                                   		// 0x0000 (0x0004) [0x0000000000000000]              
	int                                                m_nSecondAdjIdx;                                  		// 0x0004 (0x0004) [0x0000000000000000]              
	unsigned long                                      m_bInRange : 1;                                   		// 0x0008 (0x0004) [0x0000000000000000] [0x00000001] 
	unsigned long                                      m_bForbiddenBoundary : 1;                         		// 0x0008 (0x0004) [0x0000000000000000] [0x00000002] 
};

// ScriptStruct TgGame.TgMapTracker_Cliodhna_Psv.CliodhnaPsvWall
// 0x0024
struct FCliodhnaPsvWall
{
	TArray< struct FCliodhnaPsvWallSegment >           m_wallSegments;                                   		// 0x0000 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FVector2D                                   m_vBoundsCenter;                                  		// 0x000C (0x0008) [0x0000000000000000]              
	float                                              m_fBoundsRadius;                                  		// 0x0014 (0x0004) [0x0000000000000000]              
	float                                              m_fDistanceSq;                                    		// 0x0018 (0x0004) [0x0000000000000000]              
	int                                                m_nWallId;                                        		// 0x001C (0x0004) [0x0000000000000000]              
	unsigned long                                      m_bIsClosedLoop : 1;                              		// 0x0020 (0x0004) [0x0000000000000000] [0x00000001] 
	unsigned long                                      m_bInFrontOfCamera : 1;                           		// 0x0020 (0x0004) [0x0000000000000000] [0x00000002] 
};

// ScriptStruct TgGame.TgMapTracker_Cliodhna_Psv.CliodhnaPsvWallIntersectingAdjacency
// 0x0010
struct FCliodhnaPsvWallIntersectingAdjacency
{
	struct FVector2D                                   m_vWallIntersection;                              		// 0x0000 (0x0008) [0x0000000000000000]              
	int                                                m_nPlayAreaIdx;                                   		// 0x0008 (0x0004) [0x0000000000000000]              
	int                                                m_nWorldGeoIdx;                                   		// 0x000C (0x0004) [0x0000000000000000]              
};
...
struct FMeshPool
{
	TArray< class ATgSkeletalMeshActorSpawnable* >     m_meshes;                                         		// 0x0000 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
};
...
struct FMiniMapServerEntity
{
	...
	class AActor*                                      FogOfWarArea;                                     		// 0x004C (0x0004) [0x0000000000000000]              
	unsigned long                                      FogOfWarAreaRevealed : 1;                         		// 0x0050 (0x0004) [0x0000000000000000] [0x00000001] 
};
...
{
	class ATgSplineActor*                              Spline;                                           		// 0x0000 (0x0004) [0x0000000000000000]              
	float                                              SplineDist;                                       		// 0x0004 (0x0004) [0x0000000000000000]              
	unsigned long                                      bMoving : 1;                                      		// 0x0008 (0x0004) [0x0000000000000000] [0x00000001] 
};
...
{
	TArray< int >                                      m_nConquestFireMinions;                           		// 0x0000 (0x000C) [0x0000000000400002]              ( CPF_Const | CPF_NeedCtorLink )
	TArray< int >                                      m_nJoustFireMinions;                              		// 0x000C (0x000C) [0x0000000000400002]              ( CPF_Const | CPF_NeedCtorLink )
	TArray< int >                                      m_nClashFireMinions;                              		// 0x0018 (0x000C) [0x0000000000400002]              ( CPF_Const | CPF_NeedCtorLink )
	TArray< int >                                      m_nAssaultFireMinions;                            		// 0x0024 (0x000C) [0x0000000000400002]              ( CPF_Const | CPF_NeedCtorLink )
	TArray< int >                                      m_nSiegeFireMinions;                              		// 0x0030 (0x000C) [0x0000000000400002]              ( CPF_Const | CPF_NeedCtorLink )
	TArray< int >                                      m_nSlashFireMinions;                              		// 0x003C (0x000C) [0x0000000000400002]              ( CPF_Const | CPF_NeedCtorLink )
};
...
{
	class ATgDevice*                                   RefundedDevice;                                   		// 0x0000 (0x0004) [0x0000000000000000]              
	int                                                RefundedDeviceFireInstance;                       		// 0x0004 (0x0004) [0x0000000000000000]              
};
...
// ScriptStruct TgGame.TgPawn_Cliodhna.CliodhnaInvalidWallExitData
// 0x0018
struct FCliodhnaInvalidWallExitData
{
	struct FVector                                     m_vLocation;                                      		// 0x0000 (0x000C) [0x0000000000000000]              
	struct FVector                                     m_vNormal;                                        		// 0x000C (0x000C) [0x0000000000000000]              
};
...
struct FSanityBreakMeshMaterialResourceGroupData
{
	...
	struct FPointer                                    c_pSanityBreakMaterialResourceGroup;              		// 0x0008 (0x0004) [0x0000000000001000]              ( CPF_Native )
};
...
{
	class ATgPawn*                                     VictimPawn;                                       		// 0x0000 (0x0004) [0x0000000000000000]              
	class ATgPawn*                                     attackerPawn;                                     		// 0x0004 (0x0004) [0x0000000000000000]              
	struct FTraceHitInfo                               HitInfo;                                          		// 0x0008 (0x001C) [0x0000000000080000]              ( CPF_Component )
};
...
// ScriptStruct TgGame.TgPawn_IzanamiSkin.IzanamiHandArray
// 0x0004
struct FIzanamiHandArray
{
	unsigned char                                      m_eHand[ 0x4 ];                                   		// 0x0000 (0x0004) [0x0000000000000000]              
};

// ScriptStruct TgGame.TgPawn_IzanamiSkin.IzanamiToggleableVxgFxInfo
// 0x0008
struct FIzanamiToggleableVxgFxInfo
{
	unsigned char                                      m_eSkinState;                                     		// 0x0000 (0x0001) [0x0000000000000000]              
...
// ScriptStruct TgGame.TgPawn_Obelisk_Conquest_S9.ReplicatedInactiveTime
// 0x0008
struct FReplicatedInactiveTime
{
	int                                                m_nReplicatedCount;                               		// 0x0000 (0x0004) [0x0000000000000000]              
	float                                              m_fInactiveTime;                                  		// 0x0004 (0x0004) [0x0000000000000000]              
};
...
// ScriptStruct TgGame.TgPawn_Snakeman_Flagbearer.FlagbearerTransform
// 0x0018
struct FFlagbearerTransform
{
	struct FVector                                     m_vLocation;                                      		// 0x0000 (0x000C) [0x0000000000000000]              
	struct FRotator                                    m_rRotation;                                      		// 0x000C (0x000C) [0x0000000000000000]              
};

// ScriptStruct TgGame.TgPawn_Snakeman_Flagbearer.FlagbearerPathPoint
// 0x0020
struct FFlagbearerPathPoint
{
	float                                              m_fTimeStamp;                                     		// 0x0000 (0x0004) [0x0000000000000000]              
	float                                              m_fDistanceFromStart;                             		// 0x0004 (0x0004) [0x0000000000000000]              
	struct FFlagbearerTransform                        m_transform;                                      		// 0x0008 (0x0018) [0x0000000000000000]              
};

// ScriptStruct TgGame.TgPawn_Snakeman_Flagbearer.FlagbearerFollowerMeshData
// 0x0008
struct FFlagbearerFollowerMeshData
{
	class ATgPawn*                                     m_pawnFollower;                                   		// 0x0000 (0x0004) [0x0000000000000000]              
	class UTgSkeletalMeshComponent*                    m_meshComponentTravelBall;                        		// 0x0004 (0x0004) [0x0000000004080008]              ( CPF_ExportObject | CPF_Component | CPF_EditInline )
};
...
struct FChaliceInfo
{
	class UTgStaticMeshComponent*                      m_Mesh;                                           		// 0x0000 (0x0004) [0x0000000004080008]              ( CPF_ExportObject | CPF_Component | CPF_EditInline )
	struct FVector                                     m_vLocation;                                      		// 0x0004 (0x000C) [0x0000000000000000]              
	class UTgSpecialFx*                                m_auraFx;                                         		// 0x0010 (0x0004) [0x0000000000000000]              
};
...
{
	struct FPointer                                    m_pawnInstigator;                                 		// 0x0000 (0x0004) [0x0000000000001002]              ( CPF_Const | CPF_Native )
	struct FName                                       m_nmVisibilityLayer;                              		// 0x0004 (0x0008) [0x0000000000000002]              ( CPF_Const )
	struct Fdword                                      m_dwVisibilityFlags;                              		// 0x000C (0x0004) [0x0000000000000000]              
};
...
struct FCH08_GOO_FX
{
	...
	class ATgSkeletalMeshActor*                        gooPreviewActor;                                  		// 0x0020 (0x0004) [0x0000000000000000]              
	class UTgSpecialFx*                                gooPreviewFX;                                     		// 0x0024 (0x0004) [0x0000000000000000]              
};
...
struct FFOG_FX
{
	...
	class ATgSurvivalFogVolumeDensityInfo*             sphericalFogFx;                                   		// 0x0004 (0x0004) [0x0000000000000000]              
	class ATgSkeletalMeshActorSpawnable*               flatFogFx;                                        		// 0x0008 (0x0004) [0x0000000000000000]              
};
...
{
	TArray< class ATgPawn_Snakeman_Flagbearer* >       m_pawnFlagbearers;                                		// 0x0000 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	class ATgDeployableFactory_LaneSpecific*           m_factoryDeployLaneSpecific;                      		// 0x000C (0x0004) [0x0000000000000000]              
	class ATgBotFactory_LanePushers*                   m_factoryLanePushers;                             		// 0x0010 (0x0004) [0x0000000000000000]              
};
...
{
	class USkelControlBase*                            SkelControl;                                      		// 0x0000 (0x0004) [0x0000000000000000]              
	float                                              DrawY;                                            		// 0x0004 (0x0004) [0x0000000000022000]              ( CPF_Transient | CPF_EditConst )
};
...
struct FTgSkelControlSingleBoneSkinControls
{
	...
	TArray< unsigned char >                            SkinOverrideStrengthEmoteNameList;                		// 0x0004 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	TArray< struct FName >                             SkinOverrideFullBodyAnimNameList;                 		// 0x0010 (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	TArray< struct FName >                             SkinOverrideAnimNodeNameList;                     		// 0x001C (0x000C) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
};
...
{
	class USkelControlBase*                            SkelControl;                                      		// 0x0000 (0x0004) [0x0000000000000000]              
	unsigned char                                      nBytePropertyValue;                               		// 0x0004 (0x0001) [0x0000000000000001]              ( CPF_Edit )
	float                                              fFloatPropertyValue;                              		// 0x0008 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	unsigned long                                      bBoolPropertyValue : 1;                           		// 0x000C (0x0004) [0x0000000000000001] [0x00000001] ( CPF_Edit )
	int                                                nIntPropertyValue;                                		// 0x0010 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              DrawY;                                            		// 0x0014 (0x0004) [0x0000000000022000]              ( CPF_Transient | CPF_EditConst )
};
...
{
	unsigned long                                      bWasInitialized : 1;                              		// 0x0000 (0x0004) [0x0000000000000000] [0x00000001] 
	class AActor*                                      CachedOwner;                                      		// 0x0004 (0x0004) [0x0000000000002000]              ( CPF_Transient )
	struct FPointer                                    CachedByteProperty;                               		// 0x0008 (0x0004) [0x0000000000003002]              ( CPF_Const | CPF_Native | CPF_Transient )
	struct FPointer                                    CachedFloatProperty;                              		// 0x000C (0x0004) [0x0000000000003002]              ( CPF_Const | CPF_Native | CPF_Transient )
	struct FPointer                                    CachedBoolProperty;                               		// 0x0010 (0x0004) [0x0000000000003002]              ( CPF_Const | CPF_Native | CPF_Transient )
	struct FPointer                                    CachedIntProperty;                                		// 0x0014 (0x0004) [0x0000000000003002]              ( CPF_Const | CPF_Native | CPF_Transient )
};
...
{
	class USkelControlBase*                            SkelControl;                                      		// 0x0000 (0x0004) [0x0000000000000000]              
	int                                                nSkinId;                                          		// 0x0004 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	int                                                nSkinLevel;                                       		// 0x0008 (0x0004) [0x0000000000000001]              ( CPF_Edit )
	float                                              DrawY;                                            		// 0x000C (0x0004) [0x0000000000022000]              ( CPF_Transient | CPF_EditConst )
};
...
// ScriptStruct TgGame.TgSkeletalMeshActor_Lobby.BotIdFilterOverridePair
// 0x0008
struct FBotIdFilterOverridePair
{
	int                                                m_nBotId;                                         		// 0x0000 (0x0004) [0x0000000000000002]              ( CPF_Const )
	int                                                m_nCustomFilterOverride;                          		// 0x0004 (0x0004) [0x0000000000000002]              ( CPF_Const )
};
...
{
	struct FString                                     SkinPackage;                                      		// 0x0000 (0x000C) [0x0000000000500000]              ( CPF_NeedCtorLink )
	TArray< struct FString >                           PackageFlags;                                     		// 0x000C (0x000C) [0x0000000000500000]              ( CPF_NeedCtorLink )
};
...
{
	int                                                nSkinId;                                          		// 0x0000 (0x0004) [0x0000000000000000]              
	TArray< struct FPackageCookFlagMap >               SkinPackageRefs;                                  		// 0x0004 (0x000C) [0x0000000000500000]              ( CPF_NeedCtorLink )
};
...
{
	int                                                nBotId;                                           		// 0x0000 (0x0004) [0x0000000000000000]              
	TArray< struct FSkinAssemblyPackages >             SkinAssemblies;                                   		// 0x0004 (0x000C) [0x0000000000500000]              ( CPF_NeedCtorLink )
	TArray< struct FString >                           BotPackageRefs;                                   		// 0x0010 (0x000C) [0x0000000000500000]              ( CPF_NeedCtorLink )
};
...
// ScriptStruct TgGame.TgSplineActorPool.SplineActorPool
// 0x0010
struct FSplineActorPool
{
	TArray< class ATgSplineLoftActorSpawnable* >       m_splineActors;                                   		// 0x0000 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	int                                                m_nTotalSplineActorCount;                         		// 0x000C (0x0004) [0x0000000000000000]              
};

// ScriptStruct TgGame.TgSplineActorPool_Cliodhna_Psv.CliodhnaPsvWallSpline
// 0x0020
struct FCliodhnaPsvWallSpline
{
	struct FSplineContainer                            m_splineData;                                     		// 0x0000 (0x001C) [0x0000000000400000]              ( CPF_NeedCtorLink )
	int                                                m_nWallId;                                        		// 0x001C (0x0004) [0x0000000000000002]              ( CPF_Const )
};

// ScriptStruct TgGame.TgSplineActorPool_Cliodhna_Psv.CliodhnaPsvWallFadeData
// 0x0018
struct FCliodhnaPsvWallFadeData
{
	struct FVector2D                                   m_vFadeTargets;                                   		// 0x0000 (0x0008) [0x0000000000000002]              ( CPF_Const )
	float                                              m_fFadeTime;                                      		// 0x0008 (0x0004) [0x0000000000000002]              ( CPF_Const )
	float                                              m_fFadeTarget;                                    		// 0x000C (0x0004) [0x0000000000000000]              
	float                                              m_fFadeDifference;                                		// 0x0010 (0x0004) [0x0000000000000000]              
	float                                              m_fFadeValue;                                     		// 0x0014 (0x0004) [0x0000000000000000]              
};

// ScriptStruct TgGame.TgTitanForgeTools.LineSegment2D
// 0x0010
...
// ScriptStruct TgGame.TgTitanForgeTools.ScopeTimeAccumulator
// 0x000C
struct FScopeTimeAccumulator
{
	struct FDouble                                     m_dStartSeconds;                                  		// 0x0000 (0x0008) [0x0000000000000002]              ( CPF_Const )
	struct FPointer                                    m_pTotalSeconds;                                  		// 0x0008 (0x0004) [0x0000000000001000]              ( CPF_Native )
};

// ScriptStruct TgGame.TgTitanForgeTools.CompressedIndexPair
// 0x0004
struct FCompressedIndexPair
{
	struct Fdword                                      m_dwIndexPair;                                    		// 0x0000 (0x0004) [0x0000000000000000]              
};

// ScriptStruct TgGame.TgTitanForgeTools.DwBitMask
// 0x0004
struct FDwBitMask
{
	struct Fdword                                      m_dwBitMask;                                      		// 0x0000 (0x0004) [0x0000000000000000]              
};
...
{
	class ATgPawn*                                     trackedPawn;                                      		// 0x0000 (0x0004) [0x0000000000000000]              
	float                                              TrackedPawnTime;                                  		// 0x0004 (0x0004) [0x0000000000000000]              
	unsigned long                                      bWaitingForKill : 1;                              		// 0x0008 (0x0004) [0x0000000000000000] [0x00000001] 
};

// ScriptStruct TgGame.TgGame_InventoryBuildCache.TeamComp
// 0x0005
struct FTeamComp
{
...
// ScriptStruct TgGame.TgGame_InventoryBuildCache.BuildItem
// 0x000C
struct FBuildItem
{
	TArray< int >                                      m_BuildItemIds;                                   		// 0x0000 (0x000C) [0x0000000000500000]              ( CPF_NeedCtorLink )
};

// ScriptStruct TgGame.TgGame_InventoryBuildCache.BuildLibrary
// 0x000C
struct FBuildLibrary
{
	TArray< struct FBuildItem >                        m_Builds;                                         		// 0x0000 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
};

// ScriptStruct TgGame.TgGame_InventoryBuildCache.BotBuildPair
// 0x000C
...
// ScriptStruct TgGame.TgGame_InventoryBuildCache.BotBuildMap
// 0x0010
struct FBotBuildMap
{
	int                                                m_nBotId;                                         		// 0x0000 (0x0004) [0x0000000000000000]              
	TArray< struct FBotBuildPair >                     m_BuildPairs;                                     		// 0x0004 (0x000C) [0x0000000000500000]              ( CPF_NeedCtorLink )
};

// ScriptStruct TgGame.TgGame_InventoryBuildCache.BuildMap
// 0x0014
struct FBuildMap
{
	int                                                m_nModeType;                                      		// 0x0000 (0x0004) [0x0000000000000000]              
	int                                                m_nDefaultGameMode;                               		// 0x0004 (0x0004) [0x0000000000000000]              
	TArray< struct FBotBuildMap >                      m_BotBuilds;                                      		// 0x0008 (0x000C) [0x0000000000400000]              ( CPF_NeedCtorLink )
};
