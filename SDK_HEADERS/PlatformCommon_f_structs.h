...
struct UPComBrowserManager_execOpenURL_Parms
{
	...
	unsigned long                                      bSetFocus : 1;                                    		// 0x0010 (0x0004) [0x0000000000000090] [0x00000001] ( CPF_OptionalParm | CPF_Parm )
};
...
{
	struct FString                                     FileNameWithExtension;                            		// 0x0000 (0x000C) [0x0000000000400080]              ( CPF_Parm | CPF_NeedCtorLink )
	struct FString                                     FileContents;                                     		// 0x000C (0x000C) [0x0000000000400080]              ( CPF_Parm | CPF_NeedCtorLink )
	struct FString                                     SubfolderName;                                    		// 0x0018 (0x000C) [0x0000000000400080]              ( CPF_Parm | CPF_NeedCtorLink )
};
...
{
	TArray< struct FPComPerformanceCaptureStat >       PerfStats;                                        		// 0x0000 (0x000C) [0x0000000000400082]              ( CPF_Const | CPF_Parm | CPF_NeedCtorLink )
	struct FString                                     FileContents;                                     		// 0x000C (0x000C) [0x0000000000400180]              ( CPF_Parm | CPF_OutParm | CPF_NeedCtorLink )
};
...
{
	struct FString                                     FileContents;                                     		// 0x0000 (0x000C) [0x0000000000400180]              ( CPF_Parm | CPF_OutParm | CPF_NeedCtorLink )
};
...
{
	struct FString                                     MapNameStr;                                       		// 0x0000 (0x000C) [0x0000000000400180]              ( CPF_Parm | CPF_OutParm | CPF_NeedCtorLink )
	struct FString                                     FormattedDate;                                    		// 0x000C (0x000C) [0x0000000000400180]              ( CPF_Parm | CPF_OutParm | CPF_NeedCtorLink )
	struct FString                                     FormattedTime;                                    		// 0x0018 (0x000C) [0x0000000000400180]              ( CPF_Parm | CPF_OutParm | CPF_NeedCtorLink )
};
...
{
	TArray< struct FPComPerformanceCaptureStat >       PerfStats;                                        		// 0x0000 (0x000C) [0x0000000000400180]              ( CPF_Parm | CPF_OutParm | CPF_NeedCtorLink )
};
...
struct UPComPerformanceCaptureBase_execMoveCamera_Parms
{
	...
	class AActor*                                      Node;                                             		// 0x0004 (0x0004) [0x0000000000000080]              ( CPF_Parm )
};
...
struct UPComPictureInPicture_execTestPictureInPicture_Parms
{
	...
	// class ULocalPlayer*                             LocalPlayer;                                      		// 0x0008 (0x0004) [0x0000000000000000]              
	// struct FPComPipViewDesc                         ViewDesc;                                         		// 0x000C (0x01D0) [0x0000000000400000]              ( CPF_NeedCtorLink )
};
...
{
	struct FPComPipViewDesc                            ViewDesc;                                         		// 0x0000 (0x01D0) [0x0000000000400182]              ( CPF_Const | CPF_Parm | CPF_OutParm | CPF_NeedCtorLink )
	unsigned long                                      ReturnValue : 1;                                  		// 0x01D0 (0x0004) [0x0000000000000580] [0x00000001] ( CPF_Parm | CPF_OutParm | CPF_ReturnParm )
};
...
{
	struct FPComPipViewDesc                            InViewDesc;                                       		// 0x0000 (0x01D0) [0x0000000000400182]              ( CPF_Const | CPF_Parm | CPF_OutParm | CPF_NeedCtorLink )
};
...
struct APComPlayerController_eventJoinPartySession_Parms
{
	...
	// class UOnlineGameSearch*                        NewGameSearch;                                    		// 0x0050 (0x0004) [0x0000000000000000]              
};
...
struct APComPlayerController_eventInvitePlayerToPartyByName_Parms
{
	...
	unsigned long                                      ReturnValue : 1;                                  		// 0x000C (0x0004) [0x0000000000000580] [0x00000001] ( CPF_Parm | CPF_OutParm | CPF_ReturnParm )
	// struct FUniqueNetId                             IgnoredId;                                        		// 0x0010 (0x0008) [0x0000000000000000]              
};
...
{
	struct FString                                     ExtendedBinding;                                  		// 0x0000 (0x000C) [0x0000000000400080]              ( CPF_Parm | CPF_NeedCtorLink )
...
struct UPComPlayerInput_execSetCommandBind_Parms
{
	...
	unsigned long                                      bStoreToServer : 1;                               		// 0x001C (0x0004) [0x0000000000000090] [0x00000001] ( CPF_OptionalParm | CPF_Parm )
	unsigned long                                      bStoreToINI : 1;                                  		// 0x0020 (0x0004) [0x0000000000000090] [0x00000001] ( CPF_OptionalParm | CPF_Parm )
	// struct FKeyBind                                 oldCommandBinding;                                		// 0x0024 (0x0018) [0x0000000000400000]              ( CPF_NeedCtorLink )
	// struct FKeyBind                                 oldKeyBinding;                                    		// 0x003C (0x0018) [0x0000000000400000]              ( CPF_NeedCtorLink )
	// struct FKeyBind                                 newBinding;                                       		// 0x0054 (0x0018) [0x0000000000400000]              ( CPF_NeedCtorLink )
	// int                                             nOldIndex;                                        		// 0x006C (0x0004) [0x0000000000000000]              
	// unsigned long                                   bKeyWasPreviouslyBound : 1;                       		// 0x0070 (0x0004) [0x0000000000000000] [0x00000001] 
};
...
struct UPComPlayerInput_execResetKeysToDefault_Parms
{
	...
	unsigned long                                      isForceSetKey : 1;                                		// 0x000C (0x0004) [0x0000000000000090] [0x00000001] ( CPF_OptionalParm | CPF_Parm )
};
...
struct UPComUtilityFunctions_execIsAWithStop_Parms
{
	...
	class UClass*                                      SomeBase;                                         		// 0x0004 (0x0004) [0x0000000000000082]              ( CPF_Const | CPF_Parm )
	class UClass*                                      StopAtBase;                                       		// 0x0008 (0x0004) [0x0000000000000082]              ( CPF_Const | CPF_Parm )
	unsigned long                                      ReturnValue : 1;                                  		// 0x000C (0x0004) [0x0000000000000580] [0x00000001] ( CPF_Parm | CPF_OutParm | CPF_ReturnParm )
};
...
{
	class APComVideoPlayer*                            VideoPlayer;                                      		// 0x0000 (0x0004) [0x0000000000000080]              ( CPF_Parm )
	unsigned char                                      ErrorCode;                                        		// 0x0004 (0x0001) [0x0000000000000080]              ( CPF_Parm )
};
...
{
	class AActor*                                      SpawningActor;                                    		// 0x0000 (0x0004) [0x0000000000000080]              ( CPF_Parm )
	struct FString                                     InURL;                                            		// 0x0004 (0x000C) [0x0000000000400090]              ( CPF_OptionalParm | CPF_Parm | CPF_NeedCtorLink )
	// class APComVideoPlayer*                         PComVideoPlayer;                                  		// 0x0010 (0x0004) [0x0000000000000000]              
};
