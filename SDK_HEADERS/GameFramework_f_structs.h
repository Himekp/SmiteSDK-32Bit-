...
// [0x00020900] ( FUNC_Event )
struct UGameSkelCtrl_Recoil_eventSetRecoilParam_Parms
{
};
...
{
	struct FPostProcessSettings                        PP;                                               		// 0x0000 (0x0170) [0x0000000000400180]              ( CPF_Parm | CPF_OutParm | CPF_NeedCtorLink )
};
...
struct UGameCameraBase_execUpdateCamera_Parms
{
	...
	struct FTViewTarget                                OutVT;                                            		// 0x000C (0x0034) [0x0000000000000180]              ( CPF_Parm | CPF_OutParm )
};
...
{
	struct FTViewTarget                                OutVT;                                            		// 0x0000 (0x0034) [0x0000000000000182]              ( CPF_Const | CPF_Parm | CPF_OutParm )
...
{
	struct FTViewTarget                                OutVT;                                            		// 0x0000 (0x0034) [0x0000000000000180]              ( CPF_Parm | CPF_OutParm )
	float                                              DeltaTime;                                        		// 0x0034 (0x0004) [0x0000000000000080]              ( CPF_Parm )
	// class APawn*                                    P;                                                		// 0x0038 (0x0004) [0x0000000000000000]              
	// class UGameCameraBase*                          NewCamera;                                        		// 0x003C (0x0004) [0x0000000000000000]              
	// class ACameraActor*                             CamActor;                                         		// 0x0040 (0x0004) [0x0000000000000000]              
};
...
{
	struct FTViewTarget                                VT;                                               		// 0x0000 (0x0034) [0x0000000000000182]              ( CPF_Const | CPF_Parm | CPF_OutParm )
	float                                              DeltaTime;                                        		// 0x0034 (0x0004) [0x0000000000000080]              ( CPF_Parm )
	// struct FVector                                  FocusLoc;                                         		// 0x0038 (0x000C) [0x0000000000000000]              
	// struct FVector                                  StartTrace;                                       		// 0x0044 (0x000C) [0x0000000000000000]              
	// struct FVector                                  EndTrace;                                         		// 0x0050 (0x000C) [0x0000000000000000]              
	// struct FVector                                  CamDir;                                           		// 0x005C (0x000C) [0x0000000000000000]              
	// float                                           FocusDist;                                        		// 0x0068 (0x0004) [0x0000000000000000]              
	// float                                           SubjectDist;                                      		// 0x006C (0x0004) [0x0000000000000000]              
	// float                                           Pct;                                              		// 0x0070 (0x0004) [0x0000000000000000]              
};
...
struct UGameThirdPersonCameraMode_eventGetCameraWorstCaseLoc_Parms
{
	...
	struct FTViewTarget                                CurrentViewTarget;                                		// 0x0004 (0x0034) [0x0000000000000080]              ( CPF_Parm )
...
struct APlayerCollectorGame_eventLogin_Parms
{
	...
	struct FUniqueNetId                                ConsoleUniqueId;                                  		// 0x002C (0x0008) [0x0000000000000092]              ( CPF_Const | CPF_OptionalParm | CPF_Parm )
	class APlayerController*                           ReturnValue;                                      		// 0x0034 (0x0004) [0x0000000000000580]              ( CPF_Parm | CPF_OutParm | CPF_ReturnParm )
